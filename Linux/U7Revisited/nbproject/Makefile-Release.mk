...
${OBJECTDIR}/_ext/957bd1db/U7Unit.o: ../../Source/U7Unit.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/957bd1db
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DWITH_SDL2_STATIC -I/usr/include/SDL2 -I/usr/include/glm -I/usr/include/GL -I/usr/include/stb -I/usr/include/tinyxml2 -I../../../Geist/Source -I../../../Geist/ThirdParty/soloud/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/957bd1db/U7Unit.o ../../Source/U7Unit.cpp

${OBJECTDIR}/_ext/957bd1db/model3d.o: ../../Source/model3d.cc
	${MKDIR} -p ${OBJECTDIR}/_ext/957bd1db
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DWITH_SDL2_STATIC -I/usr/include/SDL2 -I/usr/include/glm -I/usr/include/GL -I/usr/include/stb -I/usr/include/tinyxml2 -I../../../Geist/Source -I../../../Geist/ThirdParty/soloud/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/957bd1db/model3d.o ../../Source/model3d.cc

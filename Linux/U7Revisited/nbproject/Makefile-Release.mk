...
${OBJECTDIR}/_ext/d8db8d98/GuiManager.o: ../../Source/Geist/GuiManager.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/d8db8d98
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../Source/Geist -Iraylib/include -I../../ThirdParty/raylib/external -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d8db8d98/GuiManager.o ../../Source/Geist/GuiManager.cpp
...
${OBJECTDIR}/_ext/957bd1db/U7Gump.o: ../../Source/U7Gump.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/957bd1db
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../Source/Geist -Iraylib/include -I../../ThirdParty/raylib/external -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/957bd1db/U7Gump.o ../../Source/U7Gump.cpp

...
void ShapeEditorState::SetupCuboidGui() {
    ...
    m_cuboidGui->AddTextArea(GE_TOPTEXTAREA, g_SmallFont.get(), "Top Face", 3,
                             y);
    m_cuboidGui->AddTextButton(GE_TOPRESET, 60, y - 2, "Reset",
                               g_SmallFont.get());
    y += yoffset * .8f;
    ...
    m_cuboidGui->AddTextArea(GE_TOPXTEXTAREA, g_SmallFont.get(),
                             "X: " + to_string(shapeData.m_topTextureOffsetX),
                             14, y);
    ...
    m_cuboidGui->AddTextArea(GE_TOPYTEXTAREA, g_SmallFont.get(),
                             "Y: " + to_string(shapeData.m_topTextureOffsetY),
                             55, y);
    ...
    m_cuboidGui->AddTextArea(GE_TOPWIDTHTEXTAREA, g_SmallFont.get(),
    ...
    m_cuboidGui->AddTextArea(GE_TOPHEIGHTTEXTAREA, g_SmallFont.get(),
                             "H: " + to_string(shapeData.m_topTextureHeight),
                             55, y);

    y += yoffset;

    m_cuboidGui->AddTextArea(GE_FRONTTEXTAREA, g_SmallFont.get(), "Front Face",
                             3, y);
    m_cuboidGui->AddTextButton(GE_FRONTRESET, 60, y - 2, "Reset",
                               g_SmallFont.get());
    y += yoffset * .8f;
    ...
    m_cuboidGui->AddTextArea(GE_FRONTXTEXTAREA, g_SmallFont.get(),
                             "X: " + to_string(shapeData.m_topTextureOffsetX),
                             14, y);
    ...
    m_cuboidGui->AddTextArea(GE_FRONTYTEXTAREA, g_SmallFont.get(),
                             "Y: " + to_string(shapeData.m_topTextureOffsetY),
                             55, y);
    ...
    m_cuboidGui->AddTextArea(GE_FRONTWIDTHTEXTAREA, g_SmallFont.get(),
                             "W: " + to_string(shapeData.m_topTextureWidth), 14,
                             y);
    ...
    m_cuboidGui->AddTextArea(GE_FRONTHEIGHTTEXTAREA, g_SmallFont.get(),
                             "H: " + to_string(shapeData.m_topTextureHeight),
                             55, y);

    y += yoffset;

    m_cuboidGui->AddTextArea(GE_RIGHTTEXTAREA, g_SmallFont.get(), "Right Face",
                             3, y);
    m_cuboidGui->AddTextButton(GE_RIGHTRESET, 60, y - 2, "Reset",
                               g_SmallFont.get());
    y += yoffset * .8f;
    ...
    m_cuboidGui->AddTextArea(GE_RIGHTXTEXTAREA, g_SmallFont.get(),
                             "X: " + to_string(shapeData.m_topTextureOffsetX),
                             14, y);
    ...
    m_cuboidGui->AddTextArea(GE_RIGHTYTEXTAREA, g_SmallFont.get(),
                             "Y: " + to_string(shapeData.m_topTextureOffsetY),
                             55, y);
    ...
    m_cuboidGui->AddTextArea(GE_RIGHTWIDTHTEXTAREA, g_SmallFont.get(),
                             "W: " + to_string(shapeData.m_topTextureWidth), 14,
                             y);
    ...
    m_cuboidGui->AddTextArea(GE_RIGHTHEIGHTTEXTAREA, g_SmallFont.get(),
                             "H: " + to_string(shapeData.m_topTextureHeight),
                             55, y);

    y += yoffset;

    m_cuboidGui->AddTextArea(GE_TEXTUREASSIGNMENTTEXTAREA, g_SmallFont.get(),
                             "Texture Assignment:", 2, y);

    y += yoffset * .7f;

    m_cuboidGui->AddTextArea(GE_TOPSIDETEXTAREA, g_SmallFont.get(), "Top", 3,
                             y);
    m_cuboidGui->AddIconButton(GE_PREVTOPBUTTON, 40, y, g_LeftArrow);
    m_cuboidGui->AddTextArea(
        GE_TOPSIDETEXTURETEXTAREA, g_SmallFont.get(),
        m_sideDrawStrings[static_cast<int>(
            shapeData.GetTextureForSide(CuboidSides::CUBOID_TOP))],
        50, y);
    ...
    m_cuboidGui->AddTextArea(GE_FRONTSIDETEXTAREA, g_SmallFont.get(), "Front",
                             3, y);
    m_cuboidGui->AddIconButton(GE_PREVFRONTBUTTON, 40, y, g_LeftArrow);
    m_cuboidGui->AddTextArea(
        GE_FRONTSIDETEXTURETEXTAREA, g_SmallFont.get(),
        m_sideDrawStrings[static_cast<int>(
            shapeData.GetTextureForSide(CuboidSides::CUBOID_FRONT))],
        50, y);
    ...
    m_cuboidGui->AddTextArea(GE_RIGHTSIDETEXTAREA, g_SmallFont.get(), "Right",
                             3, y);
    m_cuboidGui->AddIconButton(GE_PREVRIGHTBUTTON, 40, y, g_LeftArrow);
    m_cuboidGui->AddTextArea(
        GE_RIGHTSIDETEXTURETEXTAREA, g_SmallFont.get(),
        m_sideDrawStrings[static_cast<int>(
            shapeData.GetTextureForSide(CuboidSides::CUBOID_RIGHT))],
        50, y);
    ...
    m_cuboidGui->AddTextArea(GE_BOTTOMSIDETEXTAREA, g_SmallFont.get(), "Bottom",
                             3, y);
    m_cuboidGui->AddIconButton(GE_PREVBOTTOMBUTTON, 40, y, g_LeftArrow);
    m_cuboidGui->AddTextArea(
        GE_BOTTOMSIDETEXTURETEXTAREA, g_SmallFont.get(),
        m_sideDrawStrings[static_cast<int>(
            shapeData.GetTextureForSide(CuboidSides::CUBOID_BOTTOM))],
        50, y);
    ...
    m_cuboidGui->AddTextArea(GE_BACKSIDETEXTAREA, g_SmallFont.get(), "Back", 3,
                             y);
    m_cuboidGui->AddIconButton(GE_PREVBACKBUTTON, 40, y, g_LeftArrow);
    m_cuboidGui->AddTextArea(
        GE_BACKSIDETEXTURETEXTAREA, g_SmallFont.get(),
        m_sideDrawStrings[static_cast<int>(
            shapeData.GetTextureForSide(CuboidSides::CUBOID_BACK))],
        50, y);
    ...
    m_cuboidGui->AddTextArea(GE_LEFTSIDETEXTAREA, g_SmallFont.get(), "Left", 3,
                             y);
    m_cuboidGui->AddIconButton(GE_PREVLEFTBUTTON, 40, y, g_LeftArrow);
    m_cuboidGui->AddTextArea(
        GE_LEFTSIDETEXTURETEXTAREA, g_SmallFont.get(),
        m_sideDrawStrings[static_cast<int>(
            shapeData.GetTextureForSide(CuboidSides::CUBOID_LEFT))],
        50, y);
...
void ShapeEditorState::SetupMeshGui() {
    ...
    m_meshGui->AddTextArea(GE_MODELNAMETEXTAREA, g_SmallFont.get(),
                           shapeData.m_customMeshName, 12, y);
    m_meshGui->AddIconButton(GE_NEXTMODELBUTTON, 88, y, g_RightArrow);

    y += yoffset;

    m_meshGui->AddCheckBox(GE_MESHOUTLINECHECKBOX, 4, y, g_SmallFont->baseSize,
                           g_SmallFont->baseSize);
    m_meshGui->GetElement(GE_MESHOUTLINECHECKBOX)->m_Selected =
        shapeData.m_meshOutline;
    m_meshGui->AddTextArea(GE_MESHOUTLINETEXTAREA, g_SmallFont.get(),
...
void ShapeEditorState::SetupCommonGui(Gui* gui) {
    ...
    gui->AddTextArea(GE_CURRENTSHAPEIDTEXTAREA, g_SmallFont.get(),
    ...
    gui->AddTextArea(GE_CURRENTFRAMEIDTEXTAREA, g_SmallFont.get(),
    ...
    gui->AddCheckBox(GE_USESHAPEPOINTERCHECKBOX, 4, y, g_SmallFont->baseSize,
                     g_SmallFont->baseSize);
    gui->AddTextArea(GE_USESHAPEPOINTERTEXTAREA, g_SmallFont.get(),
    ...
    gui->AddTextArea(GE_CURRENTSHAPEPOINTERIDTEXTAREA, g_SmallFont.get(),
    ...
    gui->AddTextArea(GE_CURRENTFRAMEPOINTERIDTEXTAREA, g_SmallFont.get(),
                     "PF: " + to_string(m_currentFrame), 65, y);

    y += yoffset;

    gui->AddTextButton(GE_COPYPARAMSFROMFRAME0, 8, y - 2, "Copy From Frame 0",
                       g_SmallFont.get());

    y += yoffset;
    gui->AddTextArea(GE_TWEAKPOSITIONTEXTAREA, g_SmallFont.get(),
                     "Tweak Pos: ", 2, y);
    gui->AddTextArea(GE_TWEAKDIMENSIONSTEXTAREA, g_SmallFont.get(),
                     "Tweak Dims: ", 62, y);
    ...
    out.str("");
    out.precision(1);
    gui->AddTextArea(GE_TWEAKROTATIONTITLEAREA, g_SmallFont.get(),
                     "Tweak Rot:", 2, y);
    gui->AddIconButton(GE_TWEAKROTATIONPLUSBUTTON, 62, y, g_LeftArrow,
                       g_LeftArrow, g_LeftArrow, "", g_SmallFont.get(),

...
void ShapeEditorState::SetupBboardGui()
{
	...
	m_bboardGui->AddTextButton(GE_DRAWTYPEBBOARD, 4, y, "Bboard", g_Font.get());
	m_bboardGui->AddTextButton(GE_DRAWTYPEFLAT, 41, y, "Flat", g_Font.get());
	m_bboardGui->AddTextButton(GE_DRAWTYPECUBOID, 62, y, "Cuboid", g_Font.get());
	m_bboardGui->AddTextButton(GE_DRAWTYPECUSTOMMESH, 96, y, "Mesh", g_Font.get());
...
void ShapeEditorState::SetupFlatGui()
{
	...
	m_flatGui->AddTextButton(GE_DRAWTYPEBBOARD, 4, y, "Bboard", g_Font.get());
	m_flatGui->AddTextButton(GE_DRAWTYPEFLAT, 41, y, "Flat", g_Font.get());
	m_flatGui->AddTextButton(GE_DRAWTYPECUBOID, 62, y, "Cuboid", g_Font.get());
	m_flatGui->AddTextButton(GE_DRAWTYPECUSTOMMESH, 96, y, "Mesh", g_Font.get());
...
void ShapeEditorState::SetupCuboidGui()
{
	...
	m_cuboidGui->AddTextButton(GE_DRAWTYPEBBOARD, 4, y, "Bboard", g_Font.get());
	m_cuboidGui->AddTextButton(GE_DRAWTYPEFLAT, 41, y, "Flat", g_Font.get());
	m_cuboidGui->AddTextButton(GE_DRAWTYPECUBOID, 62, y, "Cuboid", g_Font.get());
	m_cuboidGui->AddTextButton(GE_DRAWTYPECUSTOMMESH, 96, y, "Mesh", g_Font.get());
...
void ShapeEditorState::SetupMeshGui()
{
	...
	m_meshGui->AddTextButton(GE_DRAWTYPEBBOARD, 4, y, "Bboard", g_Font.get());
	m_meshGui->AddTextButton(GE_DRAWTYPEFLAT, 41, y, "Flat", g_Font.get());
	m_meshGui->AddTextButton(GE_DRAWTYPECUBOID, 62, y, "Cuboid", g_Font.get());
	m_meshGui->AddTextButton(GE_DRAWTYPECUSTOMMESH, 96, y, "Mesh", g_Font.get());
	...
	m_meshGui->AddTextArea(GE_TEXTUREASSIGNMENTTEXTAREA, g_Font.get(), "Texture Assignment:", 2, y);

	y += yoffset * .7f;

	m_meshGui->AddTextArea(GE_TOPSIDETEXTAREA, g_Font.get(), "Top", 3, y);
	m_meshGui->AddIconButton(GE_PREVTOPBUTTON, 40, y, g_LeftArrow);
	m_meshGui->AddTextArea(GE_TOPSIDETEXTURETEXTAREA, g_Font.get(), m_sideDrawStrings[static_cast<int>(shapeData.GetTextureForSide(CuboidSides::CUBOID_TOP))], 50, y);
	m_meshGui->AddIconButton(GE_NEXTTOPBUTTON, 95, y, g_RightArrow);
	y += yoffset * .8f;

	m_meshGui->AddTextArea(GE_FRONTSIDETEXTAREA, g_Font.get(), "Front", 3, y);
	m_meshGui->AddIconButton(GE_PREVFRONTBUTTON, 40, y, g_LeftArrow);
	m_meshGui->AddTextArea(GE_FRONTSIDETEXTURETEXTAREA, g_Font.get(), m_sideDrawStrings[static_cast<int>(shapeData.GetTextureForSide(CuboidSides::CUBOID_FRONT))], 50, y);
	m_meshGui->AddIconButton(GE_NEXTFRONTBUTTON, 95, y, g_RightArrow);
	y += yoffset * .8f;

	m_meshGui->AddTextArea(GE_RIGHTSIDETEXTAREA, g_Font.get(), "Right", 3, y);
	m_meshGui->AddIconButton(GE_PREVRIGHTBUTTON, 40, y, g_LeftArrow);
	m_meshGui->AddTextArea(GE_RIGHTSIDETEXTURETEXTAREA, g_Font.get(), m_sideDrawStrings[static_cast<int>(shapeData.GetTextureForSide(CuboidSides::CUBOID_RIGHT))], 50, y);
	m_meshGui->AddIconButton(GE_NEXTRIGHTBUTTON, 95, y, g_RightArrow);
	y += yoffset * .8f;

	m_meshGui->AddTextArea(GE_BOTTOMSIDETEXTAREA, g_Font.get(), "Bottom", 3, y);
	m_meshGui->AddIconButton(GE_PREVBOTTOMBUTTON, 40, y, g_LeftArrow);
	m_meshGui->AddTextArea(GE_BOTTOMSIDETEXTURETEXTAREA, g_Font.get(), m_sideDrawStrings[static_cast<int>(shapeData.GetTextureForSide(CuboidSides::CUBOID_BOTTOM))], 50, y);
	m_meshGui->AddIconButton(GE_NEXTBOTTOMBUTTON, 95, y, g_RightArrow);
	y += yoffset * .8f;

	m_meshGui->AddTextArea(GE_BACKSIDETEXTAREA, g_Font.get(), "Back", 3, y);
	m_meshGui->AddIconButton(GE_PREVBACKBUTTON, 40, y, g_LeftArrow);
	m_meshGui->AddTextArea(GE_BACKSIDETEXTURETEXTAREA, g_Font.get(), m_sideDrawStrings[static_cast<int>(shapeData.GetTextureForSide(CuboidSides::CUBOID_BACK))], 50, y);
	m_meshGui->AddIconButton(GE_NEXTBACKBUTTON, 95, y, g_RightArrow);
	y += yoffset * .8f;

	m_meshGui->AddTextArea(GE_LEFTSIDETEXTAREA, g_Font.get(), "Left", 3, y);
	m_meshGui->AddIconButton(GE_PREVLEFTBUTTON, 40, y, g_LeftArrow);
	m_meshGui->AddTextArea(GE_LEFTSIDETEXTURETEXTAREA, g_Font.get(), m_sideDrawStrings[static_cast<int>(shapeData.GetTextureForSide(CuboidSides::CUBOID_LEFT))], 50, y);
	m_meshGui->AddIconButton(GE_NEXTLEFTBUTTON, 95, y, g_RightArrow);
}
...
void ShapeEditorState::Update()
{
	...
	if (m_currentGui->GetActiveElementID() == GE_DRAWTYPEBBOARD)
	{
		shapeData.m_drawType = ShapeDrawType::OBJECT_DRAW_BILLBOARD;
		ChangeGui(m_bboardGui.get());
	}

	else if (m_currentGui->GetActiveElementID() == GE_DRAWTYPEFLAT)
	{
		shapeData.m_drawType = ShapeDrawType::OBJECT_DRAW_FLAT;
		ChangeGui(m_flatGui.get());
	}

	else if (m_currentGui->GetActiveElementID() == GE_DRAWTYPECUBOID)
	{
		shapeData.m_drawType = ShapeDrawType::OBJECT_DRAW_CUBOID;
		ChangeGui(m_cuboidGui.get());
	}

	else if (m_currentGui->GetActiveElementID() == GE_DRAWTYPECUSTOMMESH)
	{
		shapeData.m_drawType = ShapeDrawType::OBJECT_DRAW_CUSTOM_MESH;
		ChangeGui(m_meshGui.get());
	}

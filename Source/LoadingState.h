...
public:
	...
	void LoadIFIX();
	bool ShapeIsContainer(int shapeIdx);
	bool ShapeIsEgg(int shapeIdx);
	int IREGItem(bool printDebug, int scPos[2], int containerDepth, int dataLen, unsigned char* data);
	void LoadIREG();
	void LoadVersion();
	void MakeMap();
	void LoadModels();

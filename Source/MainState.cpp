...
void MainState::OpenGump(int id) {
    ...
    gumpGui->AddTextArea(1001, g_SmallFont.get(), "This is a GUMP", 0, 20, 100,
                         g_SmallFont.get()->baseSize * 1.5f,
                         Color{255, 255, 255, 255}, GuiTextArea::CENTERED);
    // gumpGui->AddTextButton(1002, 70, 98, "<-", g_Font.get(), Color{ 255, 255,
    // 255, 255 }, Color{ 0, 0, 0, 192 }, Color{ 255, 255, 255, 255 });
    gumpGui->AddTextButton(1003, 10, 100, "CheckMark!", g_SmallFont.get(),
                           Color{255, 255, 255, 255}, Color{0, 0, 0, 192},
                           Color{255, 255, 255, 255});

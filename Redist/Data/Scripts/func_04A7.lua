...
function func_04A7(eventid, itemref)
    ...
    while true do
        ...
        elseif answer == "take action" then
            add_dialogue("\"I promise thee, I shall apply the necessary discipline to my son to insure that this bad habit he has picked up from the local riffraff will not trouble this community again.\"")

...
function npc_carrocio_0044(eventid, objectref)
    ...
    while true do
        ...
        elseif cmps("see") then
            if var_0002 ~= 7 then
                ...
                var_0006 = find_nearby_avatar(503)
                halt_scheduled(var_0006[1])
                var_0007 = delayed_execute_usecode_array(15, 503, 7765, var_0006[1])
            end
            remove_answer("see")
            return

    ...
    if eventid == 1 then
        ...
        if not answer then
            if not get_flag(28) then
                ...
                add_dialogue("\"Hello again, " .. local3 .. "!\" Katrina greets you with a smile.")
            end
            answer = get_answer()
            return
        end
        ...
        elseif answer == "job" then
            if not is_party_member(local2, local1) then
                ...
                add_dialogue("\"Following thee around, " .. local0 .. "! I shall never miss New Magincia!\"")
        ...
        elseif answer == "join" then
            ...
            if local7 >= 6 then
                add_dialogue("\"It would be an honor, " .. local0 .. "!\"")
                switch_talk_to(9)
                add_answer("leave")
                remove_answer("join")
            else
        ...
        elseif answer == "isolated" then
            add_dialogue("\"That is the way we like it here. Now we have three other strangers on the island -- besides Thee. Of course, thou couldst hardly be called a stranger. This is the largest number of visitors we have had in years.~~But, never fear, " .. local3 .. ", I am seldom lonely.\"")
        ...
        elseif answer == "bye" then
            add_dialogue("\"Pleasant days, " .. local3 .. ".\"*")
            answers = {}
            answer = nil
            return
        end

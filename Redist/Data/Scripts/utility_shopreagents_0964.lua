...
function utility_shopreagents_0964()
    start_conversation()
    ...
    while var_0000 do
        ...
        if var_0005 == 1 then
            ...
            var_0008 = ""
            var_0009 = 1
            var_0010 = utility_shop_1051(var_0008, var_0001[var_0005], var_0007, var_0004[var_0005], var_0006)
            var_0011 = 0
            add_dialogue("^" .. var_0010 .. " Okey-dokey?")
            var_0012 = ask_yes_no()
            if not var_0012 then
                add_dialogue("\"How many wouldst thou like?\"")
                var_0011 = utility_shop_1016(true, 1, 20, var_0004[var_0005], var_0009, var_0003[var_0005], var_0002[var_0005])
            end
            if var_0011 == 1 then
                add_dialogue("\"Done!\"")

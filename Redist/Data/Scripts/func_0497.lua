...
function func_0497(eventid, itemref)
    ...
    if not get_flag(710) then
        add_dialogue("This spritely fairy flutters around you, sprinkling some kind of sparkling dust on your head as she giggles.~~ \"I love thee! Yes, I do! I love thee!\"")
        set_flag(710, true)
    else
    ...
    while true do
        ...
        if answer == "name" then
            ...
            if local0 then
                switch_talk_to(1, 0)
                add_dialogue("\"Don't do it, " .. local4 .. "! Who knows what evil this strange creature might possess!\" He inspects the sprite more closely. \"Mayhaps I should try it first to be sure it is safe...\"*")
                hide_npc(1)
            end
            if local1 then
                switch_talk_to(2, 0)
        ...
        elseif answer == "job" then
            ...
            if local3 then
                add_dialogue("She flutters over Shamino's head.~~\"I love -thee-, as well!\"*")
                switch_talk_to(3, 0)
            ...
            if local1 then
                add_dialogue("Then she flies around Spark.~~\"Oooh, and I love -thee-, too!\"*")
                switch_talk_to(2, 0)
            ...
            if local2 then
                add_dialogue("Kissme then flies near Dupre.~~\"Handsome man! Handsome man! I love thee! It's true! It's true!\"*")
                switch_talk_to(4, 0)
            ...
            if local0 then
                add_dialogue("Kissme glides over to Iolo and plants a big kiss on his cheek.~~\"Yes! I love thee! Yes, I do!\"*")
                switch_talk_to(1, 0)
                add_dialogue("Iolo makes a sour face and wipes his cheek.~~ \"Avatar, that was the sloppiest, wettest, most... -disgusting- kiss I have ever felt!\"*")
                hide_npc(1)
                switch_talk_to(151, 0)
            end
        ...
        elseif answer == "stones" then
            add_dialogue("\"I believe it is called Caddellite. Yes, I believe it's true!~~\"And I -do- love thee, it is so true!\"")
        ...
        elseif answer == "years ago" then
            add_dialogue("\"Ambrosia was once very beautiful! Yes, it was! All of mine ancestors lived here then! Love dust was all around, and every day was like a jewel! Yes, it's true! Yes, thou wilt!~~\"Oh, I must kiss thee again!\"")
            if not local6 then
        ...
        elseif answer == "kiss" then
            if local0 then
                switch_talk_to(1, 0)
                add_dialogue("\"No! Don't do it, " .. local4 .. ".\"*")
                hide_npc(1)
            end
            if local1 then
                switch_talk_to(2, 0)
            ...
            if local2 then
                switch_talk_to(4, 0)
                add_dialogue("\"If thou wouldst do it, " .. local4 .. ", do it quickly. We have not time to waste with such foolishness.\" Dupre looks distinctly disgusted with the whole affair.*")
                hide_npc(4)
            end
            switch_talk_to(151, 0)
            ...
            local8 = get_answer()
            if not local8 then
                add_dialogue("Kissme places the wettest, sloppiest, oozingest, and mushiest smack you have ever felt on your mouth. ~~\"Oh, yes! That was fun! I love thee! Yes, it's true!\"")
            else

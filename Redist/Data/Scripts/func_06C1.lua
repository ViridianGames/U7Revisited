...
function func_06C1(eventid, objectref)
    ...
    if eventid == 3 then
        if get_flag(343) and not get_flag(404) then
            ...
            var_0002 = unknown_0035H(0, 15, 810, objectref)
            var_0003 = unknown_0035H(176, 15, 912, objectref)
            ...
            var_000C = unknown_0035H(0, 40, 400, objectref)
            var_000C = var_000C[unknown_0035H(0, 40, 414, objectref)]
            for i = 1, #var_000C do
                var_000F = var_000C[i]

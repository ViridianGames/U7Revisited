...
function func_049F(eventid, itemref)
    ...
    if not get_flag(513) then
        ...
        add_dialogue("\"Greetings, " .. local0 .. ". As usual, I have much to do. However, I can spare a moment for thee if necessary.\"")
    end

    while true do
        local answer = get_answer()
        if answer == "name" then
            add_dialogue("\"I am Jillian, " .. local1 .. ".\"")
            remove_answer("name")
        elseif answer == "job" then
            add_dialogue("\"I am a scholar, " .. local1 .. ". I also tutor and train those who seek knowledge here in Moonglow.\"")
        ...
        elseif answer == "bye" then
            add_dialogue("\"Fare thee well, " .. local0 .. ",\" she says, returning to her previous activity.*")
            break
        end
    end
    return

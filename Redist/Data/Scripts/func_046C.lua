...
function func_046C(eventid, objectref)
    ...
    var_0003 = false
    var_0004 = false
    var_0005 = unknown_0931H(4, 359, 999, 1, 357)
    ...
    var_0006 = unknown_000EH(-1, 715, 356)
    ...
    while true do
        ...
        elseif cmps({"cemetery", "mother"}) then
            ...
            if var_0006 == 0 then
                var_0007 = ""
                var_0008 = unknown_0035H(0, 10, 999, 108)
        ...
        elseif cmps({"have flowers", "brought flowers"}) then
            ...
            var_000C = unknown_002BH(true, 4, 359, 999, 1)
        ...
        elseif cmps("heal") then
            if var_0001 == 3 or var_0001 == 4 or var_0001 == 5 then
                ...
                if get_flag(313) then
                    ...
                    unknown_08D2H(200, 5, 15)
                else
                    unknown_08D2H(400, 10, 30)
                end
            else
        ...
        elseif cmps("emergency") then
            ...
            for var_0013 in ipairs(var_0010) do
                var_0011 = var_0011 + 1
                var_0016 = unknown_0088H(8, var_0015)
                if var_0016 then
                    var_0012 = true
                end

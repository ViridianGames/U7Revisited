...
function func_046C(eventid, itemref)
    ...
    if eventid == 1 then
        ...
        if not get_flag(326) then
            ...
            add_dialogue("\"Hello, " .. local0 .. ",\" says Reyna.")
        end
        ...
        while true do
            ...
            elseif answer == "have flowers" or answer == "brought flowers" then
                add_dialogue("Her eyes light up as she sees the bouquet of flowers.~~ \"They are lovely! Thou art too kind, " .. local0 .. ", to bring flowers for my mother! I cannot wait to set them by her grave.\"")
                set_flag(313, true)
            ...
            elseif answer == "heal" then
                ...
                if get_flag(314) then
                    ...
                    add_dialogue("\"I am sorry, " .. local0 .. ", but, unless this is an emergency, I would prefer to wait until my shop is open.\"")
            ...
            elseif answer == "emergency" then
                ...
                add_dialogue("She quickly examines you" .. local19 .. ".")
                if local15 == true then
                    set_flag(314, true)
                    add_dialogue("\"Thou art correct, " .. local0 .. ". This is a true emergency!\"")
                    add_answer("heal")
                else

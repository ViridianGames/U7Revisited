    ...
    if eventid == 1 then
        ...
        if not answer then
            if not get_flag(23) then
                ...
                add_dialogue("\"How may I assist thee, " .. local3 .. "?\" asks Sir Dupre.")
            end
            answer = get_answer()
            return
        end
        ...
        -- Process answer
        if answer == "name" then
            add_dialogue("\"Why, dost thou not recognize me? It is I, Lord British!\" he laughs. \"Dost thou not know thy friend Dupre when thou seest him, " .. local3 .. "?\"")
            if local5 then
                switch_talk_to(3, 0)
        ...
        elseif answer == "job" then
            if not get_flag(365) then
                add_dialogue("\"I have not seen our old friends in some time. Currently I am conducting a study of all of the various drinking establishments of Britannia. At present I am about halfway through. But it is nothing that could keep me from adventuring with thee, " .. local3 .. ".\"")
        ...
        elseif answer == "leave" then
            add_dialogue("\"Dost thou want me to wait here or dost thou truly want me to go home?\"")
        ...
        elseif answer == "Iolo" then
            ...
            elseif local4 then
                add_dialogue("\"" .. local3 .. ", there is a strange old man following thee, and he bears a vague resemblance to Iolo! It is most odd.\"*")
                switch_talk_to(1, 0)
        ...
        elseif answer == "Spark" then
            if local9 then
                ...
                add_dialogue("Dupre points a thumb at Spark. \"He is joining us, as well?\" He mutters at you, \"Art thou trying to make me feel old, " .. local3 .. "?\"")
            end
            remove_answer("Spark")

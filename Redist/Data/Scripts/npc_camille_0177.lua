        ...
        while true do
            ...
            elseif answer == "carrots" then
                ...
                if var_0001 then
                    ...
                    var_0002 = input_numeric_value(3, 3, 30, 3)
                    var_0003 = var_0002 / 3
                    var_0004 = remove_party_items(true, 359, 644, 359, var_0003)
                    if var_0004 then
                        var_0005 = add_party_items(true, 18, 359, 377, var_0002)
                        if var_0005 then
                            ...
                            var_0006 = add_party_items(true, 359, 644, 359, var_0003)
                        end
                    else
                        ...
                        var_0007 = add_party_items(true, 18, 359, 377, 1)
                        if var_0007 then

        ...
        if var_0009 == 1 then
            ...
            if var_0002[var_0009] == 627 or var_0002[var_0009] == 595 then
                ...
                if var_000C then
                    ...
                    var_000B = purchase_item(true, 1, 5, var_0004[var_0009], var_0008, var_0003) --- Guess: Purchases item
                end
            else
                var_000D = get_dialogue_choice() --- Guess: Gets dialogue choice
                if var_000D then
                    var_000B = purchase_item(false, 1, 0, var_0004[var_0009], var_0008, var_0003) --- Guess: Purchases item
                end
            end
            if var_000B == 1 then

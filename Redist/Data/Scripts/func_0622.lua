    ...
    if eventid == 1 then
        ...
        if var_0001 == 356 then
            ...
            if var_0002 == 0 then
                ...
                if not unknown_0801H(objectref) then --- Guess: Unknown check
                    calle_0624H(objectref) --- External call to retrieve bedroll
                end
        ...
        var_000C = unknown_0002H(33, {1571, 8021, 1590, 17493, 7715}, objectref) --- Guess: Adds items to container

...
function npc_jesse_0028(eventid, objectref)
    ...
    while true do
        ...
        elseif answer == "challenging" then
        ...
        elseif answer == "lines" then
            add_dialogue("\"My biggest lines are:")
            add_dialogue("\"Name!\"")
            add_dialogue("\"Job!\"")
            add_dialogue("\"Bye!\"")
            remove_answer("lines")
        elseif answer == "experimental works" then

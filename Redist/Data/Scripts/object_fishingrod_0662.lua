...
function object_fishingrod_0662(eventid, objectref)
    ...
    if eventid == 1 or eventid == 4 then
        ...
        var_0002 = get_object_position(-356)
        var_0002[1] = var_0002[1] + 1
        var_0003 = false
        var_0004 = 0
        var_0005 = find_nearby(0, 15, 509, -356)
        ...
        if var_0003 then
            var_0008 = create_new_object(377)
            if not var_0008 then
                get_object_frame(12, var_0008)
                set_item_flag(11, var_0008)

...
function func_066F(eventid, objectref)
    ...
    if eventid ~= 1 then
        if eventid == 2 then
            var_0002 = 25
            var_0003 = unknown_0035H(4, var_0002, -1, objectref)
    ...
    if not unknown_0906H() then
        ...
        var_0001 = unknown_0001H(objectref, {1647, 17493, 17514, 17511, 17519, 17509, 8033, 65, 7768})
    else
        var_0001 = unknown_0001H(objectref, {1542, 17493, 17514, 17511, 17519, 17509, 7777})
    end
end
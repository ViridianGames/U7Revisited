...
function object_unknown_0410(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        if var_0001 == 0 or var_0001 > 3 then
            ...
            var_0002 = execute_usecode_array({7, -10, 7947, 4, 3, -4, 7948, 8, 17496, 17409, 8013, 0, 7750}, objectref)
            var_0002 = execute_usecode_array({24, -7, 7947, 1549, 8021, 15, 17496, 17409, 8014, 0, 7750}, var_0000)
        end
    end
    return
end
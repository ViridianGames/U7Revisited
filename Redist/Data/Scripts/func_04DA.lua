            ...
            if answer == "name" then
                ...
                if local7 == local4 then
                    ...
                    if not local14 then
                        ...
                        add_dialogue("The other gargoyle also stands. Anger flashes across his face as he points a finger at you.~~ \"To be the cause for our unhappiness, ", local13, "!\"*")
                        _HideNPC(-217)
                        switch_talk_to(218, 0)
                    end
                    add_dialogue("\"To be the reason for our poverty. To die, ", local13, ", to die!\"*")
                    calli_001D(0, local0)
                    calli_001D(0, local1)
                    calli_003D(2, local1)
                    calli_003D(2, local0)

...
function func_0483(eventid, itemref)
            ...
            elseif var_0001 == "carousing" then
                ...
                if var_0002 then
                    ...
                    if var_0003 == "Constance" then
                        ...
                        if not get_flag(383) then
                            var_0004 = unknown_002CH(false, 2, 359, 955, 1) --- Guess: Checks inventory space
                            if var_0004 then
            ...
            elseif var_0001 == "surprise" then
                if not get_flag(383) then
                    ...
                    if var_0004 == "stolen" then
                        ...
                        if not get_flag(383) then
                            var_0003 = unknown_002CH(false, 2, 359, 955, 1) --- Guess: Checks inventory space
                            if var_0003 then
    ...
    elseif eventid == 0 then
        unknown_092EH(131) --- Guess: Triggers a game event
    end
end
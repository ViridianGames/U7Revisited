    ...
    if eventid() == 1 then
        ...
        while true do
            ...
            elseif cmp_strings("job", 1) then
                add_dialogue("\"The puppet's curtain I unfurl, And from mine hands the story's told, For pleasure of a boy or girl, To see doth cost one coin of gold. To take good measure of thy power, Forged in fire of virtue's heart, To ring the bell this very hour, Do test thy strength 'til thy muscles smart.\"")
                if not local4 then
            ...
            elseif cmp_strings("wicked thrill", 1) then
                add_dialogue("Carrocio looks as if he is lost in a memory. After a moment he returns to reality. \"I would not be a gentleman if I spoke of this more, Forgive me the candor of mine heart's open door.\" He appears somewhat embarrassed and clears his throat loudly several times.")

...
function func_00FA(eventid, objectref)
    ...
    if var_0000 == 1 then
        ...
        if not unknown_081DH(1, 0, 3, 0, 246, objectref) then
            -- call [0002] (081EH, unmapped)
            unknown_081EH(7, 0, 0, 0, 225, 2, 1, 392, objectref)
    ...
    elseif var_0000 == 0 then
        -- call [0001] (081DH, unmapped)
        if not unknown_081DH(7, 3, 0, 1, 246, objectref) then
            -- call [0002] (081EH, unmapped)
            unknown_081EH(7, 0, 0, 1, 225, 1, 0, 392, objectref)

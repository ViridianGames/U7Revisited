...
function func_04F0(eventid, itemref)
    ...
    if callis_001D(15, local5) then
        add_dialogue("\"I thank thee, ", local0, ". Truly thou possesseth great honor! I hope one day to be able to repay thee for thy kindness!\"*")
        return
    end
    ...
    while true do
        ...
        if answer == "name" then
            ...
            if local1 then
                ...
                add_dialogue("\"Be polite, Anton. I am sure ", local0, " is truly interested in thy name.\"")
                _HideNPC(-220)
                switch_talk_to(240, 0)
            end
            remove_answer("name")
        ...
        elseif answer == "job" then
            ...
            if local1 then
                add_dialogue("*")
                switch_talk_to(220, 0)
                add_dialogue("\"Relax, Anton. I am sure that thou wilt have a job again soon enough.\" He turns to you.~~\"He was apprenticed to the sage Alagner who bade him find out information about The Fellowship...\"")
                switch_talk_to(240, 0)
                ...
                switch_talk_to(240, 0)
                if local2 then
                    add_dialogue("Anton turns to the troll.~~\"I did?\"*")
                    switch_talk_to(154, 0)
                ...
                switch_talk_to(220, 0)
                add_dialogue("\"As I was saying, his instructor sent him to observe the Fellowship. Of course, he was discovered and brought here for torturing.\" He turns back to Anton.~~\"Never fear, however, Anton. 'Twill be no time before thou art free again, able to return to thy tutor, Alagner, and resume thy studies,\" he says, smiling.*")
                _HideNPC(-220)
                local4 = true
                add_answer("Alagner")
            end
        ...
        elseif answer == "stocks" then
            if local4 then
                ...
                add_dialogue("\"I am being held here for spying, ", local0, ". 'Tis a false accusation, but they will likely kill me anyway....\"")
        ...
        elseif answer == "they" then
            add_dialogue("\"Why, The Fellowship, ", local0, ".\"")
            remove_answer("they")
            if not local3 then
                add_answer("Fellowship")
            end
        ...
        elseif answer == "Fellowship" then
            ...
            local6 = callis_0067()
            if not local6 then
                add_dialogue("With his index finger, he motions you closer to him and lowers his voice.~~\"In a pig's eye, that is! I am departing this den of evil as soon as I get the chance. And I advise thee to do the same!\"")
            end
            local3 = true
            remove_answer("Fellowship")
        elseif answer == "bye" then
            add_dialogue("\"Do not hurry too much, ", local0, ", for the world as we know it will soon be no more.\"*")
            return
        end
    end

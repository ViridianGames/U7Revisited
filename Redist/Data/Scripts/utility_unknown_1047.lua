...
function utility_unknown_1047(iterations, npc_id)
    local var_0000, var_0001, var_0002, var_0003, var_0004, var_0005

    var_0002 = 0
    while var_0002 < iterations do
        var_0003 = get_training_level(1, npc_id) --- Guess: Gets training level
        var_0004 = get_training_level(4, npc_id) --- Guess: Gets training level
        ...
        set_training_level(4, npc_id, var_0005 - var_0004) --- Guess: Sets training level

...
function func_0683(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        if check_spell_requirements() then
            ...
            var_0001 = add_containerobject_s(objectref, {17514, 17505, 17519, 8033, 67, 17496, 7781})
            ...
            var_0007 = add_containerobject_s(objectref, {1542, 17493, 17514, 17505, 17519, 17505, 7781})
        end
    elseif eventid == 2 then
        set_object_flag(objectref, 0) --- Guess: Sets item flag
    end
end
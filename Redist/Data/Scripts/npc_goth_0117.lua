...
function npc_goth_0117(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        while true do
            ...
            elseif var_0001 == "5" then
                ...
                if var_0002 > 4 then
                    var_0003 = remove_party_items(true, 359, 359, 644, 5) --- Guess: Deducts item and adds item
            ...
            elseif var_0001 == "prisoners" then
                ...
                if var_0004 then
                    ...
                    if var_0005 > 4 then
                        var_0006 = remove_party_items(true, 359, 359, 644, 5) --- Guess: Deducts item and adds item
            ...
            elseif var_0001 == "another prisoner" then
                ...
                if var_0007 then
                    ...
                    if var_0008 > 4 then
                        ...
                        var_0009 = remove_party_items(true, 359, 359, 644, 5) --- Guess: Deducts item and adds item
            ...
            elseif var_0001 == "buy keys" then
                ...
                if var_000A then
                    ...
                    if var_000B > 19 then
                        add_dialogue("\"Done!\"")
                        var_000C = remove_party_items(false, 359, 359, 644, 20) --- Guess: Deducts item and adds item
                        var_000C = add_party_items(false, 359, 248, 641, 1) --- Guess: Checks inventory space

...
function npc_boris_0130(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        var_0001 = get_schedule(130) --- Guess: Checks game state
            ...
            elseif var_0006 == "room" then
                ...
                if select_option() then
                    ...
                    if var_000C >= var_000B then
                        var_000D = add_party_items(true, 359, 255, 641, 1) --- Guess: Checks inventory space
                        if var_000D then
                            add_dialogue("\"Here is thy room key. 'Twill only work in this inn.\"")
                            var_000E = remove_party_items(true, 359, 359, 644, var_000B) --- Guess: Deducts item and adds item
                        else

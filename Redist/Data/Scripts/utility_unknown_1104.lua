...
function utility_unknown_1104(eventid, objectref, arg1, arg2)
    ...
    var_000D = 2
    var_000E = utility_unknown_1058(var_000D, var_0002, arg1, arg2) --- External call to evaluate training ability
    if var_000E == 0 then
    ...
    elseif var_000E == 2 then
        ...
        var_0010 = remove_object_from_inventory(true, 359, 644, arg1, 359) --- Guess: Removes item from inventory

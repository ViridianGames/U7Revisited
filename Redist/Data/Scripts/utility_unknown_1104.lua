...
function utility_unknown_1104(training_cost, max_stat_value)
    local var_0002, var_0003, var_0004, var_0005, var_0006, var_0007, var_0008, var_0009, var_000A, var_000B, var_000C, var_000D, var_000E, var_000F, var_0010, var_0011, var_0012

    start_conversation()
    var_0002 = utility_unknown_1056() --- External call to select training member
    ...
    var_000D = 2
    var_000E = utility_unknown_1058(var_000D, var_0002, training_cost, max_stat_value) --- External call to evaluate training ability
    if var_000E == 0 then
    ...
    elseif var_000E == 1 then
        var_000F = check_object_ownership(359, 644, 359, 357) --- Guess: Checks item ownership
        add_dialogue("You gather your gold and count it, finding that you have " .. var_000F .. " gold altogether.")
        if var_000F < training_cost then
    ...
    elseif var_000E == 2 then
        ...
        add_dialogue("You pay " .. training_cost .. " gold.")
        var_0010 = remove_object_from_inventory(true, 359, 644, training_cost, 359) --- Guess: Removes item from inventory
        ...
        var_0011 = utility_unknown_1040(1, var_0002) --- External call to get training level
        var_0012 = utility_unknown_1040(4, var_0002) --- External call to get training level
        if var_0011 < 30 then
            utility_unknown_1045(1, var_0002) --- External call to improve dexterity training
        end
        if var_0012 < 30 then
            utility_unknown_1047(1, var_0002) --- External call to improve combat training
        end
    end
end
...
function utility_position_1062(eventid, objectref, arg1)
    ...
    var_0001 = false
    var_0002 = get_object_shape(arg1) --- Guess: Gets item type
    var_0003 = get_object_frame(arg1) --- Guess: Gets item frame
    ...
    for _, var_0008 in ipairs({6, 7, 8, 5}) do
        var_0009 = get_containerobject_s(var_0008, var_0002, var_0003, var_0004) --- Guess: Gets container items
        for _, var_000C in ipairs({10, 11, 12, 9}) do
            if var_000C == arg1 then
                var_0001 = var_0008
                var_000D = get_object_position(var_0001) --- Guess: Gets item position

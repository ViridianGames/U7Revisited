...
function object_unknown_0658(eventid, objectref)
        ...
        if var_0000 == 1 or var_0000 == 2 then
            ...
            if var_0002 == 831 then
                ...
                if not var_0003 then
                    var_0004 = get_object_position(var_0001)
                    var_0004[1] = var_0004[1] - random2(2, 1)
                    var_0004[3] = var_0004[3] + 1
                    var_0003 = update_last_created(var_0004)
                    if not var_0003 then
                        var_0003 = delayed_execute_usecode_array(60, 658, {17493, 7715}, objectref)
                        if random2(2, 1) == 1 then
                            utility_unknown_1022("@Do not over cook it!@")
                        end
                    end
                end
            end
    ...
    elseif eventid == 2 then
        ...
        var_0005 = find_nearby(0, 2, 831, objectref)
        if #var_0005 > 0 then
            return
        end
        var_0006 = create_new_object(377)
        if not var_0006 then
            ...
            if not var_0003 then
                ...
                if var_0007 == 1 then
                    utility_unknown_1022("@I believe the bread is ready.@")
                elseif var_0007 == 2 then
                    utility_unknown_1022("@Mmm... Smells good.@")
                end
            end
        end
    end

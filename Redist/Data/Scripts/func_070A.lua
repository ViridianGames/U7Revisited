...
function func_070A(eventid, objectref)
    ...
    if eventid ~= 3 then
        if eventid == 2 then
            if get_object_shape(objectref) == 154 then
                var_001A = {unknown_0018H(objectref), 200, 6}
            ...
            if get_object_shape(objectref) == 354 then
                ...
                if var_0024 < 20 and not unknown_0088H(unknown_001BH(-356), 23) then
                    ...
                    var_0002 = unknown_0001H(objectref, {1802, 8021, 1, 17447, 8047, 1, 17447, 8044, 2, 17447, 8045, 1, 17447, 8556, var_002D, 17447, 7780})
                else
                    var_002D = random2(15, 5)
                    var_0002 = unknown_0001H(objectref, {1802, 8021, 10, 8487, var_002D, 17447, 7780})
                end
            end
        end
        return
    ...
    if not _get_object_quality(objectref) and not get_flag(827) then
        set_flag(827, true)
        var_0000 = unknown_000EH(0, 154, objectref)
        if not var_0000 then
            ...
            var_0003 = unknown_0035H(0, 20, 338, objectref)

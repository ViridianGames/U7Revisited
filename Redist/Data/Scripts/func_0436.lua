    ...
    if eventid == 1 then
        ...
        if local3 == 7 then
            ...
            if local4 and local5 then
                ...
                if local6 then
                    switch_talk_to(1, 0)
                    add_dialogue("\"Hmmm. They must have seen thee coming, " .. local1 .. ".\"*")
                    hide_npc(1)
                    switch_talk_to(54, 0)
                end
                return
        ...
        if not get_flag(183) then
            ...
            if local6 then
                switch_talk_to(1, 0)
                add_dialogue("\"Hello, lad! This is " .. local0 .. ", the Avatar! This is my young apprentice, Coop. How go things, Coop?\"*")
                switch_talk_to(54, 0)

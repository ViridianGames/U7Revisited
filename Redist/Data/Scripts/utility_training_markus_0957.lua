...
function utility_training_markus_0957(cost_to_train, stat_to_train)
    ...
    npc_name = utility_select_party_member_for_training_1056()
    ...
    var_0006 = utility_check_training_okay_1058(training_points_required, npc_id, cost_to_train, stat_to_train)
    if var_0006 == 0 then

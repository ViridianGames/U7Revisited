...
function utility_unknown_0849()
    ...
    if not var_0000 then
        ...
        var_0002 = move_object(var_0001) --- Guess: Moves package
        var_0003 = remove_object(-356) --- Guess: Removes temporary item
        if not var_0003 then
            ...
            var_0003 = remove_object(-26) --- Guess: Removes alternative item

...
function utility_position_1003(var_0000, var_0001, var_0002)
    ...
    if var_0001 == 154 then
        ...
        for _, var_0010 in ipairs(var_0007) do
            ...
            if var_0011[3] < 5 then
                ...
                var_0012 = update_last_created(var_0011)
            end
        end
    elseif var_0001 == 1015 then
        var_0007 = find_nearby(0, 1, -1, objectref)
        for _, var_0010 in ipairs(var_0007) do
            var_0011 = get_object_position(var_0010)
            if var_0011[3] < 5 then
                var_0012 = set_last_created(var_0010)
    ...
    if not is_not_blocked(var_0000, var_0001, var_0005) then
        var_0004 = var_0004 + 1
        var_0007 = find_nearby(0, var_0004, -1, var_0006)
        for _, var_0010 in ipairs(var_0007) do
            var_0011 = get_object_position(var_0010)

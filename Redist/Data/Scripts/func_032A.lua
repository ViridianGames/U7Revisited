...
function func_032A(eventid, objectref)
    ...
    elseif eventid == 3 then
        ...
        if unknown_0031H(var_0003) then
            var_0004 = unknown_0001H({8033, 3, 17447, 8548, var_0005, 7769}, get_npc_name(-356))
            var_0004 = unknown_0001H({810, 8021, 2, 7975, 1682, 8021, 3, 7719}, objectref)
        else
            var_0004 = unknown_0001H({8033, 3, 17447, 8556, var_0005, 7769}, get_npc_name(-356))
            var_0004 = unknown_0001H({810, 8021, 2, 7975, 1682, 8021, 3, 7719}, objectref)
        end
    elseif eventid == 2 then
        ...
        if var_0007 == 721 or var_0007 == 989 then
            if var_0000 == 2 then
                unknown_0040H("@No, thank thee.@", get_npc_name(-356))
            elseif var_0000 == 0 then
                unknown_0040H("@The bucket is empty.@", get_npc_name(-356))
            else
                unknown_0040H("@Ahhh, how refreshing.@", get_npc_name(-356))
        ...
        elseif var_0007 == 740 then
            if var_0000 == 0 then
                ...
                unknown_0040H("@The bucket is full.@", get_npc_name(-356))
            end
    ...
    elseif eventid == 4 then
        var_000A = unknown_002AH(-359, -359, 810, get_npc_name(-356))
        ...
        var_000E = unknown_0001H({17505, 17508, 8551, var_000B, 7769}, get_npc_name(-356))
        var_000F = unknown_0001H({0, 8006, 2, 7719}, var_000A)
    elseif eventid == 7 then
        var_0010 = false
        var_0010 = unknown_000EH(5, 741, get_npc_name(-356))
        if not var_0010 then
            var_0010 = unknown_000EH(5, 719, get_npc_name(-356))
        end
        if var_0010 then
            var_0000 = unknown_0012H(objectref)
            ...
            elseif var_0000 == 1 then
                if var_0011 == 3 or var_0011 == 7 then
                    unknown_0040H("@The trough is full.@", get_npc_name(-356))
                else
                    var_0012 = var_0011 + 1
                    var_0013 = 0
                end
                ...
                if var_0011 == 0 or var_0011 == 4 then
                    unknown_0040H("@The trough is empty.@", get_npc_name(-356))
                else
                    var_0012 = var_0011 - 1
                    var_0013 = 1
                end
            end
            var_0014 = unknown_0001H({17505, 17508, 8551, var_0005, 7769}, get_npc_name(-356))
    ...
    elseif eventid == 8 then
        ...
        if var_0007 == 739 then
            if var_0015 == 4 then
                unknown_0040H("@There are only coals.@", get_npc_name(-356))
            ...
            var_0016 = unknown_0001H({8033, 2, 17447, 8556, var_0005, 7769}, get_npc_name(-356))
            ...
            var_0005 = unknown_092DH(objectref)
            var_001E = unknown_0001H({8033, 2, 17447, 8556, var_0005, 7769}, get_npc_name(-356))
    ...
    elseif eventid == 9 then
        var_0020 = unknown_000EH(10, 740, get_npc_name(-356))
        ...
        var_0022 = unknown_0001H({4, 17447, 8039, 1, 17447, 8036, 1, 17447, 8038, 1, 17447, 8037, 1, 7975, 4, 8025, 2, 17447, 8039, 2, 7769}, get_npc_name(-356))
        var_0022 = unknown_0001H({1685, 8021, 17, 7719}, objectref)
    elseif eventid == 10 then
        var_000E = unknown_0001H({8033, 3, 17447, 8044, 0, 7769}, get_npc_name(-356))

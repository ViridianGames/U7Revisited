-- Function 040A: Manages Tseramed's dialogue and interactions
function func_040A(itemref)
    -- Local variables (43 as per .localc)
    ...
    if eventid() == 1 then
        ...
        while true do
            ...
            elseif cmp_strings("leave", 1) then
                ...
                callis_0009()
                local34 = call_090BH({"go home", "wait here"})
                if local34 == "wait here" then

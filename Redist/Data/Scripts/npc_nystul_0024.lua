...
function npc_nystul_0024(eventid, objectref)
    ...
    while true do
        ...
        elseif var_0000 == "spells" then
            ...
            if var_0001 then
                utility_shop_0965() --- Guess: Processes spell purchases
            else
        ...
        elseif var_0000 == "reagents" then
            ...
            if var_0002 then
                utility_shopreagents_0966() --- Guess: Processes reagent purchases
            else
                add_dialogue("\"Oh. Never mind, then.\"")
            end

...
function func_0476(eventid, itemref)
    ...
    if eventid == 1 then
        ...
        while true do
            ...
            elseif var_0003 == "food" then
                unknown_085DH() --- Guess: Purchases food
                restore_answers()
                remove_answer("food")
            elseif var_0003 == "drink" then
                unknown_085EH() --- Guess: Purchases drink
                restore_answers()
                remove_answer("drink")
            ...
            elseif var_0003 == "tailor" then
                if var_0001 == 3 or var_0001 == 4 or var_0001 == 5 or var_0001 == 6 then
                    ...
                    if var_0004 then
                        unknown_085CH() --- Guess: Purchases clothing
                    else
    ...
    elseif eventid == 0 then
        unknown_092EH(118) --- Guess: Triggers a game event
    end
end
...
function func_0476(eventid)
    local answers = {}
    local flag_00E0 = get_flag(0x00E0) -- First meeting
    local flag_0094 = get_flag(0x0094) -- Fellowship topic
    local flag_00EF = get_flag(0x00EF) -- Butcher topic
    ...
    if eventid == 1 then
        ...
        if not flag_00E0 then
            ...
            add_dialogue("\"Hail, \" .. get_player_name() .. \",\" Bram says, wiping his cleaver.")
        end
        ...
        while true do
            ...
            elseif choice == "bye" then
                add_dialogue("\"Stay hearty, \" .. get_player_name() .. \".\"")
                break
            end
        end

...
function utility_unknown_0925(P0, P1, P2)
    ...
    if var_0003 then
        ...
        elseif var_0005 == "resurrect" then
            ...
            var_000A = find_nearest(25, 400, var_0009)
            if var_000A == 0 then
                var_000A = find_nearest(25, 414, var_0009)
                if var_000A == 0 then
        ...
        if not var_000B then
            ...
            if var_000C >= var_0007 then
                ...
                elseif var_0005 == "cure poison" then
                    ...
                    if not get_item_flag(var_0011, 8) then
                        clear_item_flag(var_0011, 8)
                        var_0010 = remove_party_items(true, -359, -359, 644, var_0007)
                        add_dialogue("\"To have healed the wounds.\"")
                    else

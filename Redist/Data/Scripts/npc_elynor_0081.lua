...
function npc_elynor_0081(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        if var_0003 == 7 and var_0004 == 28 then
            ...
            utility_ship_0891() --- Guess: Starts Fellowship ceremony
        end
        ...
        while true do
            ...
            elseif var_0006 == "deliver" then
                var_0006 = false
                var_0007 = find_object(359, 1, 798, 357) --- Guess: Checks item status
                var_0008 = find_object(359, 1, 799, 357) --- Guess: Checks item status
                var_0009 = 0
                if not var_0008 then
                    var_0009 = find_object(359, 8, 797, var_0008) --- Guess: Checks item status
                elseif not var_0007 then
                    var_0009 = find_object(359, 8, 797, var_0007) --- Guess: Checks item status
                end
                if var_0009 then
                    var_0006 = true
                end
                if var_0007 or var_0008 then
                    ...
                    if var_0007 then
                        ...
                        if var_0007 then
                            ...
                            var_000A = add_party_items(true, 359, 359, 644, 50) --- Guess: Checks inventory space
                            if var_000A then

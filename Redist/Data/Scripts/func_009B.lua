            ...
            elseif cmp_strings("Skara Brae", 0x019A) then
                if not get_flag(0x0197) then
                    ...
                    if local0 and local1 then
                        callis_0003(0, -3)
                        say("\"Er... ", local2, ", art thou sure we need to go over there?\"")
                        callis_0004(-3)
                        callis_0003(0, -2)
                        say("\"What's the matter, Shamino? Art thou -afraid-?\"")
                        callis_0004(-2)
                        callis_0003(0, -3)
                        say("\"Of course not! I just... well, I... oh, never mind! Let's go!\"")
                        callis_0004(-3)
                        local3 = call_08F7H(-1)
                        if local3 then
                            callis_0003(0, -1)
                            say("Iolo's eyes narrow as he adopts a patronizing look on his face.~~\"And I suppose thou art without fear?\" he says to Spark.")
                            callis_0004(-1)
                            callis_0003(0, -2)
                            say("\"No, sir. I am not afraid of a skeleton,\" he says. As he looks at the ferryman, however, he gulps.")
                            callis_0004(-2)
                        end
                        callis_0003(0, -285)
                    end

...
function npc_clint_0057(eventid, objectref)
        ...
        while true do
            ...
            elseif var_0004 == "buy ship deed" then
                if get_flag(210) then
                    ...
                    if var_0004 then
                        var_0005 = remove_party_items(true, 359, 359, 644, 800) --- Guess: Deducts gold and adds item
                        if var_0005 then
                            var_0006 = add_party_items(false, 359, 15, 797, 1) --- Guess: Checks inventory space
                            if var_0006 then
            ...
            elseif var_0004 == "buy sextant" then
                ...
                if var_0007 then
                    var_0008 = remove_party_items(true, 359, 359, 644, 100) --- Guess: Deducts gold and adds item
                    if var_0008 then
                        var_0009 = add_party_items(false, 359, 359, 650, 1) --- Guess: Checks inventory space
                        if var_0009 then

    ...
    if eventid == 1 then
        ...
        while true do
            ...
            elseif answer == "ship" then
                say("\"Thou dost want to buy a ship?\" the old man asks, smiling. (Apparently not too many folks buy ships these days.)")
                say("\"My ships are sturdy and well built. They may not be built by Owen, but they are fine vessels! But thou must first purchase a deed.\"")
                        ...
                        if get_answer() then
                            ...
                            if local5 >= 600 then
                                ...
                                if not local6 then
                                    ...
                                    say("\"Thou'rt already carrying enough to sink a galleon, Avatar! If thou wilt leave something behind, mayhaps thou wilt be able to sail, and I will be glad, indeed, to sell thee the deed.\" Gargan sneezes.")
                                end
                            else

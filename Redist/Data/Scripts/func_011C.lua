...
function func_011C(eventid, itemref)
    local var_0000, var_0001

    if eventid == 1 then
        var_0000 = unknown_0038H()
        if var_0000 >= 6 and var_0000 <= 11 then
            unknown_0040H(" " .. var_0000 .. " o'clock", itemref)
        elseif var_0000 == 12 then
            unknown_0040H("Noon", itemref)
        elseif var_0000 >= 13 and var_0000 <= 20 then
            var_0000 = var_0000 - 12
            unknown_0040H(" " .. var_0000 .. " o'clock", itemref)
        else
            var_0001 = unknown_0908H()
            unknown_08FFH("@^" .. var_0001 .. ", I believe the key word in sundial is `sun'.@", itemref)
        end
    end
    return
end
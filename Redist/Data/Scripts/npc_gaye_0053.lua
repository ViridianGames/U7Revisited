...
function npc_gaye_0053(eventid, objectref)
        ...
        while true do
                ...
                if var_0003 ~= 19 then
                    ...
                    if not get_flag(103) then
                        ...
                        if var_0005 then
                            ...
                            var_0006 = count_objects(359, 359, 644, 357) --- Guess: Checks player inventory or gold
                            if var_0006 < 30 then
                                add_dialogue("\"Um. Perhaps thou couldst return when thou dost have enough gold.\" She lays the costume down and smiles.")
                            else
                                var_0007 = add_party_items(false, 359, 359, 838, 1) --- Guess: Checks inventory space
                                if not var_0007 then
                                    ...
                                    var_0008 = remove_party_items(true, 359, 359, 644, 30) --- Guess: Deducts gold and adds costume
                                    set_flag(104, true)
                                end
                            end
                        else
                            add_dialogue("\"'Tis strange! I thought for certain that thou wert the theatrical type!\"")
                            utility_shop_0910() --- Guess: Processes clothing purchase
                        end
                    else
            ...
            elseif var_0005 == "Fellowship" then
                if not var_0001 then
                    utility_ship_1049() --- Guess: Explains Fellowship philosophy
                end

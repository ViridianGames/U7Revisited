...
function npc_denby_0049(eventid, objectref)
    local var_0000, var_0001

    start_conversation()
    if eventid == 1 then
        switch_talk_to(49)
        var_0000 = get_schedule(49) --- Guess: Checks game state or timer
        var_0001 = get_schedule_type(49) --- Guess: Gets object state

...
function func_047A(eventid, itemref)
    ...
    if eventid == 1 then
        ...
        if not get_flag(372) then
            ...
            say("\"I bid thee welcome once again, " .. local0 .. ",\" says Ophelia.")
        end
        ...
        while true do
                    ...
                    if get_answer() then
                        ...
                        if local15 >= local14 then
                            ...
                            if local16 then
                                ...
                                say("\"Sorry, " .. local0 .. ", thou must lose some weight, er, some bundles, before I can give thee the room key.\"")
                            end
                        else
                ...
                if local5 or local6 or local7 or local8 then
                    ...
                    if local18 then
                        ...
                        if local18 == 0 then
                            ...
                            say("\"Thou wouldst bet " .. local18 .. " gold that Sprellic will win?\"")
                            local19 = get_answer()
                            if not local19 then
                                ...
                                if local15 >= local18 then
                                    say("\"Very well. Let me give thee markers for thy gold. Each one is worth 10 gold coins. If Sprellic wins, thou mayest come collect twice that amount of gold from me.~~\"" .. local0 .. ", thy markers are, of course, worthless.\"")
                                    local20 = add_item(-359, 0, 921, math.floor(local18 / 10)) -- Unmapped intrinsic
                                    if local20 then
                                        remove_gold(-359, -359, 644, local18) -- Unmapped intrinsic
                                        set_flag(357, true)
                                        say("\"I shall soon see thee again, " .. local0 .. ".\" You notice she is suppressing a tiny giggle. \"When thou dost return to collect thy winnings.\" For a moment it seems she cannot make eye contact with you.")
                                    else
            ...
            elseif answer == "bye" then
                say("\"Do come and visit us again, " .. local0 .. ".\"*")
                break
            end
        end

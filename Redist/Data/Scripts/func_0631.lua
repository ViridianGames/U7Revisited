...
function func_0631(eventid, objectref)
    ...
    if eventid == 7 then
        ...
        var_0001 = unknown_0035H(0, 15, 870, objectref) --- Guess: Sets NPC location
        var_0002 = unknown_0035H(0, 15, 515, objectref) --- Guess: Sets NPC location
        ...
        elseif unknown_008EH(806, 356) and not get_flag(343) then
            var_0007 = unknown_008EH(20, 806, objectref) --- Guess: Checks item type

                    ...
                    if local5 then
                        ...
                        if not local8 then
                            ...
                            if local14 then
                                ...
                                add_dialogue("\"And here are " .. local13 .. " gold coins for thee in return, " .. local0 .. ". I thank thee for thy business.\"")
                            end
                        end
                    else

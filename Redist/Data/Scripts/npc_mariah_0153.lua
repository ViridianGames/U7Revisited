...
function npc_mariah_0153(eventid, objectref)
        ...
        if not get_flag(3) then
            while true do
                ...
                elseif var_0002 == "spells" then
                    utility_shop_0955(153) --- Guess: Buys spells
                elseif var_0002 == "reagents" then
                    utility_shopreagents_0956("Reagents") --- Guess: Buys reagents or potions
                elseif var_0002 == "potions" then
                    add_dialogue("\"I am afraid, " .. var_0001 .. ", that I have a very meager selection.\"")
                    utility_shopreagents_0956("Potions") --- Guess: Buys reagents or potions
    ...
    elseif eventid == 0 then
        var_0003 = get_schedule_type(153) --- Guess: Gets schedule
        var_0004 = random(1, 4)
        if var_0003 == 11 then
            if not get_flag(3) then
                if var_0004 == 1 then

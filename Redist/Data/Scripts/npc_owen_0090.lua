...
function npc_owen_0090(eventid, objectref)
    ...
    while true do
        ...
        elseif cmps("buy") then
            if var_0001 == 7 then
                if not get_flag(247) then
                    ...
                    var_0006 = ask_yes_no()
                    if var_0006 then
                        var_0007 = remove_party_items(359, 359, 644, 1000)
                        if var_0007 then
                            set_flag(251, true)
                    ...
                    if ask_yes_no() then
                        ...
                        var_000A = remove_party_items(359, 359, 644, 150)
                        if not var_000A then
                            ...
                            var_000B = add_party_items(true, 359, 359, 650, 1)
                            if not var_000B then
                                ...
                                var_000C = add_party_items(true, 359, 359, 644, 150)
                            end
                        end
                    else
        ...
        elseif cmps("methods") then
            ...
            if var_000D then
                ...
                var_000E = remove_party_items(359, 359, 644, 30)
                if var_000E then
                    var_000F = add_party_items(false, 359, 59, 642, 1)
                    if var_000F then
                        add_dialogue("\"Here it is.\"")
                    else
                        add_dialogue("\"Thou art carrying too much to take thy book.\"")
                        var_0010 = add_party_items(true, 359, 359, 644, 30)
                        if var_0010 then
        ...
        elseif cmps("ship") then
            ...
            elseif not get_flag(252) then
                ...
                if get_flag(251) then
                    ...
                    var_0011 = add_party_items(true, 359, 359, 644, 1000)
                    if var_0011 then
                        set_flag(252, true)
                    else

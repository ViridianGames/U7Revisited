...
function func_0401(eventid, itemref)
    ...
    if eventid == 3 then
        if not get_flag(59) and not get_flag(92) and not unknown_0088H(16, 356) then --- Guess: Checks a flag on an object
            ...
            var_0005 = unknown_0001H({8018, "@There, there...@", 1, 35, 17492, 7715}, 1) --- Guess: Executes a specific action with parameters
            var_0005 = unknown_0002H(16, {"@'Tis horrible!@", 17490, 7715}, 11) --- Guess: Executes a specific action with parameters
            var_0005 = unknown_0002H(33, {"@I know, 'tis shocking!@", 17490, 7715}, 1) --- Guess: Executes a specific action with parameters
            var_0005 = unknown_0002H(49, {"@Who could have done it?@", 17490, 7715}, 11) --- Guess: Executes a specific action with parameters
            var_0005 = unknown_0002H(65, {"@I know not...@", 17490, 7715}, 1) --- Guess: Executes a specific action with parameters
            var_0005 = unknown_0002H(81, {"@He had no enemies...@", 17490, 7715}, 11) --- Guess: Executes a specific action with parameters
            var_0005 = unknown_0002H(97, {"@Poor man.@", 17490, 7715}, 1) --- Guess: Executes a specific action with parameters
            var_0005 = unknown_0002H(113, {"@What is to be done?@", 17490, 7715}, 11) --- Guess: Executes a specific action with parameters
            var_0005 = unknown_0002H(129, {"@I know not...@", 17490, 7715}, 1) --- Guess: Executes a specific action with parameters
            set_flag(92, true)
            abort()
        else
    ...
    elseif get_flag(59) == false and eventid == 2 then
        ...
        add_dialogue("The distraught peasant interrupts Iolo. \"Show " .. var_0006 .. " the stables, milord. 'Tis horrible!\"")
        hide_npc(11)
        switch_talk_to(1, 0)

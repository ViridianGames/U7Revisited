...
function func_070F(eventid, objectref)
    ...
    if var_0000 == 466 then
        ...
        var_0007 = unknown_0018H(objectref)
        var_0008 = unknown_0024H(414)
        unknown_006BH(objectref)
        unknown_006CH(var_0008, objectref)
        ...
        var_000C = unknown_003CH(objectref)
        unknown_000FH(4)
        ...
        if var_000F then
            ...
            if var_0010 == 240 then
                set_flag(750, true)
                var_0012 = unknown_0018H(objectref)
                var_0011 = unknown_0024H(762)
                unknown_006BH(objectref)
                unknown_006CH(var_0011, objectref)
                get_object_frame(var_0011, 22)
                unknown_08E6H(objectref)

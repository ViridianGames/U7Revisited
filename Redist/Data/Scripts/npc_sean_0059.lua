...
function npc_sean_0059(eventid, objectref)
                ...
                if var_0005 then
                    ...
                    if var_0006 then
                        ...
                        for _, item in ipairs(var_0007) do
                            if count_objects(item, 359, 760, 357) then
                                if item == 12 then
                        ...
                        var_000B = count_objects(359, 359, 760, 357)
                        var_000C = var_000B * 30
                        var_000D = remove_party_items(359, 359, 760, var_000B)
                        if var_000B == 0 then
                        ...
                        var_000E = add_party_items(true, 359, 359, 644, var_000C)
                        if var_000E then
                            add_dialogue("\"Here is thy payment.\"")
                        else
                            add_dialogue("\"Thou art carrying too much to take thy payment!\"")
                            var_000F = add_party_items(true, 359, 359, 760, var_000B)
                        end
                    else

...
function func_0948(eventid, itemref)
    ...
    if not var_0002 then
        ...
        var_0003 = check_item_ownership(14, 359, 863, 357) --- Guess: Checks item ownership
        var_0004 = check_item_ownership(15, 359, 863, 357) --- Guess: Checks item ownership
        ...
        var_0006 = add_item_to_inventory(true, 359, 644, var_0005, 359) --- Guess: Adds item to inventory
        if not var_0006 then
            add_dialogue("@If thou dost travel in a lighter fashion, thou wouldst have hands to take my gold!@")
        else
            var_0007 = remove_item_from_inventory(true, 14, 359, 863, var_0003) --- Guess: Removes item from inventory
            var_0008 = remove_item_from_inventory(true, 15, 359, 863, var_0004) --- Guess: Removes item from inventory

    ...
    if eventid == 1 then
        ...
        while true do
            ...
            if answer == "name" then
                ...
                if local7 and not get_flag(441) then
                    ...
                    if not get_flag(420) then
                        ...
                        add_dialogue("The lovely " .. local0 .. " strolls over and pats Markham's rather large belly. \"Yes, he's Markham of the Keg, all right.\" She smiles sweetly down at the older man.*")
                        hide_npc(145)
                        switch_talk_to(140, 0)
            ...
            elseif answer == "fire" then
                ...
                add_dialogue("\"Oh, I suppose " .. local1 .. " he was tryin' ta help us when he called the proverbial fires o' Hell down on us. It just rankles me to have died in my prime.\" His roguish smile once again lightens his ghostly visage.")
                remove_answer("fire")

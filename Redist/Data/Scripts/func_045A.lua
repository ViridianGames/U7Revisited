...
function func_045A(eventid, itemref)
    ...
    if eventid == 1 then
        ...
        while true do
            ...
            if answer == "name" then
                add_dialogue("\"My name, " .. local2 .. ", is Owen. It is a name I suspect thou shalt be hearing more of in the future.\"")
                set_flag(291, true)
                remove_answer("name")
            ...
            elseif answer == "Crown Jewel" then
                if not get_flag(249) then
                    ...
                    add_dialogue("\"I have heard nothing more of the Crown Jewel since we last spoke of it, " .. local2 .. ".\"")
                end
            ...
            elseif answer == "Hook" then
                if not get_flag(250) then
                    ...
                    add_dialogue("\"I have heard nothing more of this man Hook since we last spoke of him, " .. local2 .. ".\"")
                end
                remove_answer("Hook")

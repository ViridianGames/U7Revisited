...
function npc_addom_0164(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        while true do
            ...
            elseif answer == "crystal" then
                ...
                var_0003 = ask_yes_no()
                if var_0003 then
                    var_0004 = add_party_items(false, 359, 746, 359, 1)
                    var_0005 = remove_party_items(true, 359, 644, 359, 20)
                    if var_0005 then
                        if var_0004 then
                        ...
                        var_0006 = remove_party_items(false, 359, 746, 359, 1)
                    end
                else

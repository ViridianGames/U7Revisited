...
function func_047D(eventid, itemref)
    ...
    if eventid == 1 then
        ...
        if not get_flag(375) then
            say("You see a fighting man. His voice booms like thunder as he greets you. \"Hail to thee, " .. local0 .. "!\"")
            set_flag(375, true)
        else
        ...
        while true do
            ...
            if answer == "name" then
                say("\"My name is Vokes, " .. local0 .. ". As big as a mountain, as strong as an ox, as fierce as... well, more fierce than anything thou hast ever fought!\"")
                remove_answer("name")
            elseif answer == "job" then
                say("\"Job! I am not in the habit of plowing fields or peddling vegetables, " .. local0 .. "! I earn my gold with this sword arm,\" he says as he flexes a mighty bicep. \"Right now I am in Jhelom continuing my studies in my trade with De Snel, and when I am finished my price is going to go up!\"")
                add_answer("Jhelom")

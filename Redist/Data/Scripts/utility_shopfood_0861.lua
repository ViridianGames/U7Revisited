...
function utility_shopfood_0861()
    ...
    while var_0001 do
        ...
        elseif var_000A == 4 and not get_flag(299) then
            ...
            var_000B = utility_shop_1051(var_0006, var_0002[var_000A], var_0007[var_000A], var_000A, var_0008[var_000A])
            var_000C = 0
            ...
            if not var_000D then
                ...
                var_000C = utility_shop_1016(true, var_0009[var_000A], var_0005[var_000A], 1, var_0004[var_000A], var_0003[var_000A])
                if var_000C == 1 then
                    add_dialogue("\"Agreed.\"")

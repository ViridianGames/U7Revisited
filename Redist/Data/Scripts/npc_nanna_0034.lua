...
function npc_nanna_0034(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        if var_0000 == 7 then
            var_0003 = utility_unknown_1020(26, 34) --- Guess: Checks time for Fellowship meeting
            if var_0003 then
        ...
        while true do
            ...
            elseif var_0004 == "children" then
                ...
                var_0006 = get_schedule_type(32) --- Guess: Gets object state
                if var_0006 == 25 then
            ...
            elseif var_0004 == "philosophy" then
                if var_0002 then
                    ...
                    utility_ship_1050() --- Guess: Provides detailed Fellowship information
                end
    ...
    elseif eventid == 0 then
        utility_unknown_1070(34) --- Guess: Triggers a game event
    end
end
...
function npc_kessler_0237(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        while true do
            ...
            elseif answer == "venom" then
                var_0005 = count_objects(359, 359, 649, 357)
                ...
                if ask_yes_no() then
                    var_0007 = remove_party_items(true, 359, 359, 649, var_0005)
                    if not var_0007 then
                        var_0008 = add_party_items(true, 359, 359, 644, var_0006)

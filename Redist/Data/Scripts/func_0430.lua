...
function func_0430(eventid, itemref)
    ...
    while true do
        ...
        elseif answer == "half-sister" then
            ...
            add_dialogue("\"Mine half-sister is Eiko. She, like myself, is a warrior trained by Karenna in the ways of combat. We studied long and hard together to master the skills that " .. local2 .. " required to achieve our vengeance.\"")
            if local1 then
                switch_talk_to(15, 0)
        ...
        elseif answer == "inner peace" then
            add_dialogue("\"Yes. Our lives have been dedicated to vengeance for so long that we feel adrift, aimless without it. We must find a new reason for living.~~\"We are considering joining The Fellowship, as they offer guidance for lost souls. But we must consider this longer. We are still unsure.\"")
        elseif answer == "quest" then
            add_dialogue("\"We are on the trail of our father's murderer.\"")
            remove_answer("quest")
            add_answer("killer")
        elseif answer == "killer" then
            add_dialogue("\"Our father was slain in a most violent manner by a vicious and terrible cyclops. He was impaled on a spear. It took several hours for him to die.\"~~She looks up, eyes glittering. \"Hast thou ever watched anyone die from a belly wound, " .. local0 .. "? The agony cannot be imagined.\"")
        ...
        elseif answer == "bye" then
            add_dialogue("\"Good journey to thee, " .. local0 .. ".\"*")
            break
        end
    end
    return

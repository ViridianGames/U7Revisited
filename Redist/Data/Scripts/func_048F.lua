...
function func_048F(eventid, objectref)
    ...
    var_000D = unknown_0022H()
    var_000E = unknown_000EH(25, 400, var_000D)
    if var_000E == 0 then
        var_000E = unknown_000EH(25, 414, var_000D)
    end
    if var_000E ~= 0 then
        var_000F = 0
        var_000F = var_000E
        unknown_091FH(var_000E, var_000F)
        var_0002 = true
    end
    for var_0010 in ipairs(var_000A) do
        unknown_008AH(var_0010, 8)
        unknown_08BFH(var_0010)
    end

...
function func_048F(eventid, itemref)
    ...
    if eventid == 1 then
        ...
        if not get_flag(426) then
            if local6 == 0 or local6 == 1 then
                ...
                elseif local9 ~= 16 then
                    say("\"I am sorry, " .. local0 .. ". Do not take offense, but I must rest before we speak further. I thank thee for thy patience, young one.\" She looks very weary as she turns away.*")
                    return
                end
            end
        end
        ...
        if not get_flag(456) then
            say("\"Hello, " .. local0 .. ". Thou mayest call me Mistress Mordra.\" She peers at you closely.~~\"And thou must be " .. local1 .. ", the Avatar.\" She looks you over thoroughly.")
            set_flag(456, true)
        else
            say("\"Greetings once again, " .. local1 .. ".\"")
            local8 = true
        end
        ...
        while true do
            ...
            if answer == "name" then
                say("She smiles at you. \"Thou art quite forgetful, " .. local1 .. ". As I have told thee, I am known as Mordra.\"")
                remove_answer("name")
            ...
            elseif answer == "lives" then
                ...
                if not local18 then
                    ...
                    say("\"Very well, " .. local0 .. ". What wouldst thou care to know about?\"")
                end
                remove_answer("lives")
            ...
            elseif answer == "bye" then
                say("\"Goodbye, young " .. local1 .. ". Take care of thyself, but should ill befall thee, I hope that thou wilt come back here and let me minister to thine ailments.\" She smiles kindly as you leave.*")
                break
            end
        end

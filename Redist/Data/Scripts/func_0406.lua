...
function func_0406(eventid, itemref)
    ...
    if eventid == 1 then
        ...
        if not get_flag(25) then
            ...
            if local5 then
                switch_talk_to(1, 0)
                add_dialogue("\"Boy, this is the Avatar! Upon my word he is! He has come to help thee!\"*")
                hide_npc(1)
                switch_talk_to(6, 0)
            end
            ...
            if not answer then
                add_dialogue("\"You are greeted, " .. local7 .. ".\"")
                answers = {}
        ...
        elseif answer == false then
            add_dialogue("\"You are very odd, " .. local7 .. ".\"")
            remove_answer({"join", "go there"})

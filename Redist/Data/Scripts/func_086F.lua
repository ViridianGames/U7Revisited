...
function func_086F()
    ...
    if random(0, 3) == 0 then
        var_0000 = random(0, 1) == 0 and calle_0865H() or calle_0866H() --- External call to noun generator
    else
        var_0000 = random(0, 1) == 0 and calle_086CH() or calle_086DH() --- External call to noun generator
    end
    var_0001 = var_0000[1] --- Guess: Singular noun
    var_0002 = var_0000[2] --- Guess: Plural noun
    var_0003 = random(0, 1) == 0 and calle_0865H() or calle_0866H() --- External call to noun generator
    var_0004 = random(0, 1) == 0 and calle_0865H() or calle_0866H() --- External call to noun generator
    var_0005 = random(0, 1) == 0 and calle_0865H() or calle_0866H() --- External call to noun generator
    var_0005 = var_0005[2] --- Guess: Plural noun
    var_0000 = calle_0867H() --- External call to noun generator
    var_0006 = var_0000[1] --- Guess: Singular noun
    var_0007 = var_0000[2] --- Guess: Plural noun
    var_0000 = random(0, 1) == 0 and calle_0868H() or calle_0869H() --- External call to noun generator
    var_0008 = var_0000[1] --- Guess: Singular noun
    var_0009 = var_0000[2] --- Guess: Plural noun
    var_000A = var_0000[3] --- Guess: Additional noun
    var_000B = random(0, 1) == 0 and calle_086AH() or calle_086BH() --- External call to noun generator
    var_0000 = random(0, 1) == 0 and calle_086CH() or calle_086DH() --- External call to noun generator
    var_000C = var_0000[1] --- Guess: Singular noun
    var_000D = var_0000[2] --- Guess: Plural noun
    var_000E = calle_086EH() --- External call to insult generator

...
function npc_sam_0137(eventid, objectref)
                ...
                if var_0003 == 7 then
                    ...
                    if var_000A then
                        ...
                        if var_000B then
                            ...
                            if var_000C >= 12 then
                                var_000D = add_party_items(true, 4, 359, 999, 1) --- Guess: Deducts item and checks inventory
                                if var_000D then
                                    add_dialogue("\"The bouquet is thine!\"")
                                    remove_party_items(true, 359, 359, 644, 12) --- Guess: Deducts item and adds item
                                else

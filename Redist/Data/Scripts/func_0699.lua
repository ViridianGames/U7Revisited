...
function func_0699(eventid, objectref)
    ...
    var_0000 = unknown_0018H(objectref, 8, 6) --- Guess: Gets position data with array dimensions
    var_0001 = unknown_0035H(16, 40, 275, var_0000) --- Guess: Sets NPC location
    var_0002 = unknown_0018H(objectref, 9, 6) --- Guess: Gets position data with array dimensions

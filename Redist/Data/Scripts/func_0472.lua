...
function func_0472(eventid, itemref)
                ...
                if var_0002 then
                    ...
                    if var_0003 then
                        if get_flag(296) and not get_flag(348) then
                            ...
                            var_0004 = unknown_002CH(true, 4, 359, 999, 1) --- Guess: Checks inventory space
                            set_flag(348, true)
                        else
                            ...
                            var_0003 = select_option()
                            if var_0003 then
                                var_0006 = unknown_0931H(359, 359, 644, 10, 357) --- Guess: Checks item in inventory
                                var_0007 = unknown_002CH(true, 4, 359, 999, 1) --- Guess: Checks inventory space
                                if var_0006 then
                                    if var_0007 then
                                        var_0008 = unknown_002BH(true, 359, 359, 644, 10) --- Guess: Deducts item and adds item
    ...
    elseif eventid == 0 then
        unknown_092EH(114) --- Guess: Triggers a game event
    end
end
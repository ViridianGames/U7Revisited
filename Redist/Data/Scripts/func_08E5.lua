...
function func_08E5(local0, local1)
    ...
    elseif local5 == 2 then
        ...
        add_dialogue("\"On guard!\" Sentri cries as he draws his sword. ", local8, " ", local9, " forced to respond with the most easily readied weapon ", local8, ". Without a word, Sentri advances upon ", local11, ", swinging his blade in a seemingly wild, yet entirely controlled manner. ", local8, " ", local9, " forced to block his blows to the best of ", local12, " ability. Luckily, Sentri stops just short of striking ", local11, ", which he is often able to do. Slowly but surely, over the course of the training session, ", local12, " blocking improves and ", local8, " ", local13, " to get in a few thrusts of ", local12, " own. ", local12, " agility improves, and the improvement is tangibly perceptible.")

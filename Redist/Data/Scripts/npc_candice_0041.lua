...
function npc_candice_0041(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        var_0002 = get_schedule(41) --- Guess: Checks game state or timer
        if var_0002 == 7 then
            var_0003 = utility_unknown_1020(26, 41) --- Guess: Checks time for Fellowship meeting
            if var_0003 then
    ...
    elseif eventid == 0 then
        utility_unknown_1070(41) --- Guess: Triggers a game event
    end
end
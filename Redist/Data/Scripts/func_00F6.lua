...
function func_00F6(eventid, itemref)
    ...
    if local0 == 1 then
        if call_081DH(5, 3, 0, 0, 250, itemref) == 0 then
            call_081EH(7, 0, 0, 0, 392, 1, 1, 225, itemref)
    ...
    elseif local0 == 0 then
        if call_081DH(7, 0, -3, 1, 250, itemref) == 0 then
            call_081EH(7, 0, 0, 1, 392, 2, 0, 225, itemref)

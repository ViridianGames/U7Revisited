...
function utility_shopreagents_0956(eventid)
    start_conversation()
    ...
    while var_0001 do
        ...
        if var_0012 == 1 then
            ...
            var_0013 = utility_shop_1051(var_0006 or var_0008[var_0012], var_0002[var_0012], var_0009, var_0005[var_0012], var_0007[var_0012])
            var_0014 = 0
            ...
            if not var_0015 then
                if eventid == "Reagents" then
                    ...
                    var_0014 = utility_shop_1016(false, 1, 20, var_0005[var_0012], var_0010, var_0004[var_0012], var_0003[var_0012])
                else
                    var_0014 = utility_shop_1016(false, 1, 0, var_0005[var_0012], var_0010, var_0004[var_0012], var_0003[var_0012])
                end
            end
            if var_0014 == 1 then
                add_dialogue("\"Done!\"")

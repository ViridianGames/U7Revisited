...
function utility_event_0318(eventid, objectref)
    local var_0000, var_0001, var_0002, var_0003, var_0004, var_0005

    if eventid == 3 then
        var_0000 = set_last_created(-23)
        if not var_0000 then
            var_0001 = get_object_position(-356)
            var_0000 = update_last_created({var_0001[2] - 4, var_0001[1]})
            get_object_frame(-23, 16)
        end
        var_0000 = delayed_execute_usecode_array(1, {1598, 17493, 7715}, -356)
    ...
    elseif eventid == 2 then
        ...
        var_0000 = execute_usecode_array(21, 14422)
        var_0002 = get_party_members()
        for var_0003 in ipairs(var_0002) do
            set_item_flag(7, var_0005)
        end
        set_weather(2)
        armageddon()
        set_flag(30, true)
        set_alignment(2, -23)
        set_attack_mode(0, -23)
        set_schedule_type(0, -23)

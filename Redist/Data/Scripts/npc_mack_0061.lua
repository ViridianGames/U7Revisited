...
function npc_mack_0061(eventid, objectref)
    ...
    while true do
        ...
        elseif answer == "another place" then
        ...
        elseif answer == "bright lights" then
        ...
        elseif answer == "lost" then
            ...
            remove_answer("lost")
        elseif answer == "Kill Wrathy" then

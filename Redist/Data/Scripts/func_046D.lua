...
function func_046D(eventid, itemref)
    ...
    if eventid == 1 then
        ...
        if not get_flag(714) then
            ...
            add_dialogue("\"Greetings, " .. local0 .. ". May I help thee?\" asks Wayne.")
        end

        while true do
            local answer = get_answer()
            if answer == "name" then
                add_dialogue("\"Thou mayest call me Brother Wayne, " .. local0 .. ".\"")
                remove_answer("name")
            ...
            elseif answer == "at the moment" then
                add_dialogue("\"Yes, I am... Well, I am lost, " .. local0 .. ". I am from the Abbey to the south of here... or to the north.... Mayhaps the northwest.\" He cradles his chin and looks up.~~\"Southeast?\"")
            ...
            elseif answer == "plants" then
                add_dialogue("\"Ah, yes, " .. local0 .. ", they are quite wondrous to see. I highly recommend to thee to always observe thy surroundings. Otherwise, " .. local0 .. ", thou wilt miss much in life: flowers, trees, birds... landmarks!\"")
            ...
            elseif answer == "flowers" then
                add_dialogue("\"Very, very lovely plants. All the colors of the rainbow, and then some. One of the monks at the Abbey had a lovely flower garden. She may still tend it for all that I know, " .. local0 .. ".\"")
                remove_answer("flowers")
                if not get_flag(332) then
                    add_answer("She still does.")
                end
            elseif answer == "She still does." then
                add_dialogue("\"Excellent, " .. local0 .. ". I am glad to hear it. 'Twould be a shame were Aimi to give that up for her other... pastime.\"")

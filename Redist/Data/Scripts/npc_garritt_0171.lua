...
function npc_garritt_0171(eventid, objectref)
    local var_0000, var_0001, var_0002, var_0003, var_0004, var_0005, var_0006, var_0007, var_0008

    start_conversation()
    if eventid == 1 then
        switch_talk_to(NPC_GARRITT)
        ...
        -- usecode: Tobias option after Feridwyn framed him
        if get_flag(FLAG_TOBIAS_FRAMED) then
            add_answer("Tobias")
        end
        var_0002 = is_object_in_party_inventory(SHAPE_SILVER_SERPENT_VENOM)
        if var_0002 then
        ...
        while true do
            ...
            elseif var_0003 == "Tobias" then
                ...
                elseif not get_flag(FLAG_TOBIAS_FRAMED) then
            ...
            elseif var_0003 == "found venom" then
                ...
                set_flag(FLAG_VENOM_CASE_SOLVED, true)
            ...
            elseif var_0003 == "parents" then
                ...
                if var_0005 then
                    ...
                    set_flag(FLAG_GARRITT_PARENTS_SECRET, true)
                end
            ...
            elseif var_0003 == "bye" then
                ...
                if not get_flag(FLAG_VENOM_CASE_SOLVED) then
                    set_schedule_type(NPC_GARRITT, 25)
                end
                clear_answers()
                break
            end
    ...
    elseif eventid == 0 then
        var_0006 = get_schedule_type(get_npc_name(NPC_GARRITT))
        var_0007 = random(1, 4)
        if var_0006 == 25 then
            if var_0007 == 1 then
                var_0008 = "@Nyah nyah!@"

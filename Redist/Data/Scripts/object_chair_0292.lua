...
function object_chair_0292(eventid, objectref)
    ...
    if eventid == 1 then
        if get_barge(objectref) then
            ...
            var_0002 = get_distance(-356, objectref) + 15
            var_0001 = delayed_execute_usecode_array(var_0002, {292, 17493, 7715}, objectref)
        end
    elseif eventid == 2 then
        var_0003 = get_object_position(-356)
        ...
        if var_0003[1] == var_0005[1] and var_0003[2] == var_0005[2] and get_flag(743) == false then
            set_flag(743, true)
            var_0007 = sprite_effect(-1, 0, 0, 0, var_0005[2] + 1, var_0005[1] + 1, 17)
            set_object_quality(objectref, 62)
            start_endgame()
            var_0007 = create_new_object(895)
            if not var_0007 then
                set_item_flag(18, var_0007)
                var_0001 = update_last_created(var_0005)
            end
            abort()
        end
        var_0008 = 1

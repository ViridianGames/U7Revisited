...
function utility_unknown_0294(eventid, objectref)
    ...
    if var_0000 == 518 then
        call_guards() --- Guess: Resets item state
        find_nearby(0, 6, 518, objectref) --- Guess: Sets NPC location
        ...
        var_0006 = get_object_position(objectref) --- Guess: Gets position data
        var_0007 = 1
            ...
            while var_000B <= var_0007 do
                ...
                if distance_to_object(var_000A[1], var_000C, var_0006[1], var_0006[2]) <= 2 and
                   distance_to_object(var_000A[2], var_000C + 1, var_0006[2], var_0006[3]) <= 2 then
                    remove_item(var_0005) --- Guess: Unknown object operation
                    var_0006[i] = var_000A
                    var_0007 = var_0007 + 1
                else
                    var_000B = var_000B + 1

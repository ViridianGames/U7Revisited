...
function func_084E()
    ...
    var_0001 = unknown_090BH({"B: Friend has disappointed me", "A: I disappointed a friend"})
    ...
    var_0002 = unknown_090BH({"B: Lie to him", "A: Tell the truth"})
    ...
    var_0003 = unknown_090BH({"B: Leave the room as is", "A: Clean the room myself"})
    ...
    var_0004 = unknown_090BH({"B: I wanted to please friends", "A: I enjoyed the response"})
    ...
    var_0005 = unknown_090BH({"B: I duplicated the coin", "A: I stole the money"})
    ...
    var_0006 = unknown_090BH({"B: Respect the man", "A: Heed the healer"})
    ...
    var_0007 = unknown_090BH({"B: It was to attack another", "A: It was to attack me"})
    ...
    var_0008 = unknown_090BH({"B: My mother", "A: My betrothed"})

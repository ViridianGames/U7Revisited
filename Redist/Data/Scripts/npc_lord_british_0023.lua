        ...
        while true do
            ...
            elseif var_0009 == "Iolo" then
                ...
                if var_0003 then
                    ...
                    second_speaker(1, 0, "\"I am well, my liege! 'Tis good to see thee!\"")
                end
                remove_answer("Iolo")
                add_answer("Trinsic")
            elseif var_0009 == "Shamino" then
                ...
                if var_0005 then
                    ...
                    second_speaker(3, 0, "\"Mine apologies, milord,\" Shamino says.")
                    add_dialogue("\"What's this I hear of a woman? An actress? Hmmmm?\"")
                    second_speaker(3, 0, "Shamino blushes and shuffles his feet.")
            ...
            elseif var_0009 == "Dupre" then
                ...
                if var_0004 then
                    ...
                    second_speaker(4, 0, "\"Oh, here and there, milord,\" the fighter replies.")
                    ...
                    second_speaker(4, 0, "\"If thou dost wish it, milord,\" Dupre says, bowing.")
                end
                remove_answer("Dupre")
                add_answer("Jhelom")

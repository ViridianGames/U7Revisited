...
function func_031D(itemref)
    ...
    elseif local0 == 7 then
        ...
        add_dialogue(", the Avatar - ( )", local1)
    elseif local0 == 8 then
        add_dialogue("The stone pedestal should be four feet high, three feet wide and two feet deep. Atop each of the three pedestals shall be set the three receptacles: the tetrahedron, the sphere, and the cube.~~All of these items for the defense mechanism of the portal have already been constructed by the Trinsic blacksmith.")
    ...
    elseif local0 == 32 then
        ...
        add_dialogue("Whereby the participants belonging to the Stone Masons's Guild may register complaints unto the party of the Cabin Builders, represented here as and/or by members for the Wood-Builders Guild with the intent of...")
    ...
    elseif local0 == 36 then
        ...
        add_dialogue(".~~     'Til I see thee again, my love!~     Gwenno")

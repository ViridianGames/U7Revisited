    ...
    if eventid == 1 then
        ...
        if not npc_in_party(44) then
            ...
            if unknown_090AH() then
                ...
                var_0000 = unknown_0001H({0, 8006, 31, -1, 17419, 8014, 0, 17478, 7715}, objectref)
                var_0000 = unknown_0001H({85, 8024, 2, 7975, 83, 8024, 3, 7975, 83, 8024, 85, 8024, 1, 7975, 84, 8024, 83, 8024, 85, 8024, 11, 17447, 7715}, objectref)
            end
            hide_npc(44)
        end
    end

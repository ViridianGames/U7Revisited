...
function func_06FC(eventid, itemref)
    ...
    if eventid == 2 then
        ...
        var_0002 = false
        var_0003 = unknown_0018H(unknown_001BH(356))
        ...
        var_0007 = unknown_0001H({7769, var_0006}, unknown_001BH(356))
    ...
    elseif eventid == 1 then
        var_0011 = unknown_0035H(0, 80, 797, unknown_001BH(356))
        for i = 1, #var_0011 do
            var_0014 = var_0011[i]
            ...
            if var_0015 == 150 and var_0016 == 4 then
                unknown_007EH()
                var_0017 = unknown_0018H(unknown_001BH(356))

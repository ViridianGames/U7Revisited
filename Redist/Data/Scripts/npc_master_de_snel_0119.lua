...
function npc_master_de_snel_0119(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        var_0001 = get_schedule(119) --- Guess: Checks game state
        var_0002 = get_schedule_type(119) --- Guess: Gets object state
        ...
        var_0004 = is_dead(124) --- Guess: Checks quest status
        if var_0004 then
            add_answer("Sprellic")
        end
        var_0005 = is_dead(125) --- Guess: Checks quest status
        var_0006 = is_dead(126) --- Guess: Checks quest status
        var_0007 = is_dead(127) --- Guess: Checks quest status
        ...
        while true do
            ...
            elseif var_0008 == "demonstration" then
                if get_flag(364) then
                    ...
                    set_alignment(2, var_0003) --- Guess: Initiates combat

...
function func_0947(eventid, itemref)
    ...
    _SaveAnswers()
    say(itemref, "\"Excellent! Dost thou have some loaves for me?\"")
    local0 = get_answer()
    if local0 then
        ...
        if local11 == 0 then
            say(itemref, "\"Thou have not made enough bread to be worthy of any payment at all.\"")
            return
        end
        say(itemref, "\"Scrumptious! " .. local6 .. " loaves! That means I owe thee " .. local11 .. " gold. Here thou art! I shall take the loaves from thee now!\"")
        ...
        say(itemref, "\"No? What hast thou been doing? -Loaf-ing around? Ha ha ha!\"")
    end
    _RestoreAnswers()
    return
end
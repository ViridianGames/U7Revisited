...
function npc_finnigan_0012(eventid, objectref)
    ...
    debug_print("Starting function 040C - Finnigan")
    if eventid ~= 1 then
        if eventid == 0 then
            var_000C = get_schedule_type(get_npc_name(12))
    ...
    while true do
        ...
        elseif answer == "Pay me now, please" then
            ...
            var_0009 = add_party_items(true, 359, 359, 644, 100)

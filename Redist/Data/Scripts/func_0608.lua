...
function func_0608(eventid, itemref)
    ...
    add_dialogue("\"I say -kill- the Avatar! " .. local1 .. " is dangerous! Cut " .. local2 .. " throat! I say we attack -now-!\"*")
    hide_npc(273)
    ...
    add_dialogue("Abraham yells, \"Let us make fish bait out of " .. local3 .. "!\"*")
    hide_npc(275)
    ...
    switch_talk_to(26, 0)
    add_dialogue("\"So be it! The Fellowship hereby sentences the Avatar to immediate death! Kill " .. local3 .. " now!\"*")
    hide_npc(26)

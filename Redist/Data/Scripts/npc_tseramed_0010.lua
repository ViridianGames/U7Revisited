...
function npc_tseramed_0010(eventid, objectref)
    ...
    var_0003 = utility_unknown_1084(get_npc_name(-356))
    ...
    var_0015 = false
    var_0016 = false
    var_0017 = find_nearby(0, 13, 529, var_0004)
    var_0018 = find_nearby(0, 13, 510, var_0004)
    var_0019 = find_nearby(0, 13, 532, var_0004)
    var_001A = find_nearby(0, 20, 494, var_0004)
    ...
    if not get_flag(29) and get_flag(349) then
        utility_unknown_1010(var_0000, var_0006)
        return
    end
    if var_0004 == var_0002 then
        utility_unknown_1012(var_0000, var_0007)
    ...
    while true do
        ...
        elseif cmps("introduce") then
            var_0003 = utility_unknown_1013(var_0002, var_0003)
            cmps("introduce")
        ...
        elseif cmps("foxes") then
            var_000F = true
            if not find_nearby(0, 10, 510, var_0004) then
        ...
        elseif cmps("arrows") then
            ...
            if not get_flag(339) then
                var_0023 = count_objects(59, 359, 947, 357)
                if var_0023 > 6 then
                    var_0023 = 6
                end
                var_0024 = count_objects(59, 359, 568, 357)
            ...
            if var_0022 ~= "" then
                ...
                if ask_yes_no() then
                    var_0025 = add_party_items(false, 359, 359, 568, var_0023)
                    if var_0025 then
                        ...
                        if not get_flag(339) then
                            var_001F = remove_party_items(359, 359, 947, var_0023)
                        end
                        set_flag(339, true)
                    else

...
function func_0457(eventid, itemref)
        ...
        while true do
            ...
            elseif var_0004 == "buy weapons" then
                if var_0002 ~= 13 then
                    ...
                    unknown_0952H() --- Guess: Purchases weapons
                end
            elseif var_0004 == "buy armour" then
                if var_0002 ~= 13 then
                    ...
                    unknown_0953H() --- Guess: Purchases armour
                end
            ...
            elseif var_0004 == "helmet" then
                ...
                var_0005 = unknown_0028H(359, 359, 728, 357) --- Guess: Counts items
                if var_0005 == 0 then
                ...
                elseif var_0004 > var_0005 then
                    ...
                    var_0006 = unknown_002BH(false, 359, 359, 728, var_0005) --- Guess: Deducts item and adds item
                    if var_0005 == 1 then
                    ...
                    var_0007 = unknown_002CH(false, 359, 359, 638, var_0005) --- Guess: Checks inventory space
                    if var_0007 then
                        set_flag(262, true)
                        unknown_0911H(200) --- Guess: Submits item or advances quest
    ...
    elseif eventid == 0 then
        ...
        if var_0002 == 13 then
            ...
            unknown_092EH(87) --- Guess: Triggers a game event
        end
    end
end
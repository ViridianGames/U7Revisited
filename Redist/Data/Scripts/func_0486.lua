...
function func_0486(eventid, itemref)
    ...
    if eventid == 1 then
        ...
        while true do
            ...
            if answer == "name" then
                add_dialogue("\"My name, " .. local0 .. ", is Robin. A pleasure to meet thee. I have come to New Magincia only recently.\"")
                set_flag(399, true)
                remove_answer("name")
            ...
            elseif answer == "occupation" then
                add_dialogue("\"Why, that most glamorous and respected of occupations, " .. local0 .. ". Winning at games of chance.\"")
            ...
            elseif answer == "bye" then
                add_dialogue("\"It has been a pleasure speaking with thee, " .. local0 .. ".\"*")
                break
            end
        end

...
function utility_ship_0891()
    ...
    if var_0000 then
        switch_talk_to(-82) --- Guess: Switches to Gregor
    ...
    if var_0002 then
        switch_talk_to(-91) --- Guess: Switches to Burnside
    ...
    if var_0003 then
        switch_talk_to(-93) --- Guess: Switches to William
    ...
    if var_0004 then
        switch_talk_to(-97) --- Guess: Switches to Mikos
    ...
    switch_talk_to(-81) --- Guess: Switches back to Elynor

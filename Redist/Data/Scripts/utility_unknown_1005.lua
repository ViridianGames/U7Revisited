--- Best guess: Manages a dialogue with an ape-like creature requesting honey, offering a reward and setting a flag if honey is given, identical to func_08DE, func_08DF, func_08E0, and func_08EE except for NPC ID.
function utility_unknown_1005()
    start_conversation()

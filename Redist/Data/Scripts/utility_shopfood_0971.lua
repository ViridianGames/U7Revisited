...
function utility_shopfood_0971()
    start_conversation()
    ...
    while var_0001 do
        ...
        elseif var_0010 == 4 and not get_flag(299) then
            ...
            var_0011 = utility_shop_1051(var_0006[var_0010], var_0002[var_0010], var_0007[var_0010], var_0005[var_0010], var_0008[var_0010])
            var_0012 = 0
            add_dialogue("^" .. var_0011 .. ". Art thou happy with the price?")
            var_0013 = ask_yes_no()
            if not var_0013 then
                add_dialogue("\"How many dost thou want?\"")
                var_0012 = utility_shop_1016(true, 1, 20, var_0005[var_0010], var_0009[var_0010], var_0004[var_0010], var_0003[var_0010])
            end
            if var_0012 == 1 then
                add_dialogue("\"Agreed.\"")

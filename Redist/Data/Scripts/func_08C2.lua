...
function func_08C2()
    ...
    callis_0004(-147)
    callis_0003(0, -143)
    add_dialogue("I suppose thou hadst better get thee hence, then. Fare thee well, Forsythe. 'Tis not all that bad, roaming the ether. At least not once thou becomest accustomed to it.\"~~She turns to you. \"Goodbye, ", local1, ". If thou art successful, I will not see thee again. May thy fortunes be good.\"")
    abort()

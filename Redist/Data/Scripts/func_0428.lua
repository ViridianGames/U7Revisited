    ...
    if eventid == 1 then
        ...
        while true do
            ...
            elseif answer == "husband" then
                add_dialogue("\"Thou mightest know him. He is Patterson, the Town Mayor. He is an intelligent and honest man, but we have our differences.~~\"I do not know why I am telling thee all of this!\"")
            ...
            elseif answer == "works" then
                add_dialogue("\"He is always saying he has to work late. Some nights he comes home before dawn. Other nights he is out the entire night.~~\"Well, I must not think about it. I only become saddened. I must concentrate on my music.\"")
                remove_answer("works")

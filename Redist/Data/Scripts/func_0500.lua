...
function func_0500(eventid, itemref)
    ...
    if not get_flag(336) then
        add_dialogue("A ball of light approaches you.~~\"'You' are not the entity known as 'Trellek'. 'You' call out in the manner of the species called 'emps'. 'Xorinia' was expecting the entity 'Trellek'.")
        ...
        add_dialogue("The Wisp glows brightly a second or two.~~\"'Xorinia' wishes to exchange information with the human entity.\"")
        set_flag(336, true)

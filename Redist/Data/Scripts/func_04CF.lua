...
function func_04CF(eventid, itemref)
    ...
    while true do
        ...
        if answer == "name" then
            add_dialogue("\"Me name is Yongi, ", local1, ".\"")
            remove_answer("name")
            if not local6 then
                add_dialogue("\"And ye are?\"")
                local7 = call_090BH({local1, local2, local0})
                if local7 == local2 then
                    add_dialogue("\"Aye, ", local1, ". Right ye are. If ye dinna care ta tell me, I don't mind a bit.\" He winks.")
                elseif local7 == local0 then
                    add_dialogue("\"Welcome ta me tavern, ", local0, ".\"")
                elseif local7 == local1 then
                    add_dialogue("\"Right ye are, ", local1, ". There's no need ta tell anyone yer name.\"")
                end
            end

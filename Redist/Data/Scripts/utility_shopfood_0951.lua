...
function utility_shopfood_0951()
    start_conversation()
    ...
    while var_0001 do
        ...
        elseif var_0011 == 7 then
            ...
            var_0012 = utility_shop_1051(var_0006, var_0002[var_0011], var_0007, var_0005[var_0011], var_0008[var_0011])
            var_0013 = 0
            ...
            if not var_0014 then
                if var_0003[var_0011] == 377 then
                    ...
                    var_0013 = utility_shop_1016(true, 1, 20, var_0005[var_0011], var_0009, var_0004[var_0011], var_0003[var_0011])
                else
                    var_0013 = utility_shop_1016(true, 1, 0, var_0005[var_0011], var_0009, var_0004[var_0011], var_0003[var_0011])
                end
            end
            if var_0013 == 1 then
                add_dialogue("\"Done!\"")

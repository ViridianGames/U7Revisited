    ...
    if eventid == 1 then
        ...
        if var_0002 == 7 then
            ...
            if var_0004 and var_0005 then
                ...
                if var_0006 then
                    second_speaker(1, 0, "\"Hmmm. They must have seen thee coming, " .. var_0001 .. ".\"")
                end
                abort()
            else
        ...
        if not get_flag(183) then
            ...
            if var_0006 then
                second_speaker(1, 0, "\"Hello, lad! This is " .. var_0000 .. ", the Avatar! This is my young apprentice, Coop. How go things, Coop?\"")
                add_dialogue("\"Not too badly, milord. I sold a triple crossbow this morning.\"")
                second_speaker(1, 0, "\"Lovely! Lovely! Keep that gold coming in, that's what I always say!\"")
            end
            set_flag(183, true)
        else
        ...
        while true do
            ...
            elseif var_0007 == "responsibility" then
                ...
                if var_0006 then
                    second_speaker(1, 0, "\"Yes, the lad is good! He was good before I taught him the first lesson.\"")
                end
            ...
            elseif var_0007 == "Iolo" then
                ...
                second_speaker(1, 0, "\"Greetings, lad. Thou art looking well.\"")

...
function func_0477(eventid)
    local answers = {}
    local flag_00E1 = get_flag(0x00E1) -- First meeting
    local flag_0094 = get_flag(0x0094) -- Fellowship topic
    local flag_00F0 = get_flag(0x00F0) -- Cobbling topic
    ...
    if eventid == 1 then
        ...
        if not flag_00E1 then
            ...
            add_dialogue("\"Hail, \" .. get_player_name() .. \",\" Soren says, tapping a sole.")
        end
        ...
        while true do
            ...
            elseif choice == "bye" then
                add_dialogue("\"Tread lightly, \" .. get_player_name() .. \".\"")
                break
            end
        end

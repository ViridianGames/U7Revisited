...
function func_08A6(local0, local1)
    ...
    if local9 == 0 then
        add_dialogue("Karenna looks at ", local4, " and gives a small laugh. \"Thou art not without skill, but thou art not ready yet.\"")
    ...
    elseif local9 == 2 then
        add_dialogue("Karenna glares at ", local4, ". \"Thou dost but waste my time. Thou art as swift and cunning as I, and I would wager that thou didst know it. I have not the time for such as thee.\"")
    else
        local11 = callis_002B(true, -359, -359, 644, local0)
        add_dialogue("You pay ", local0, " gold, and the training session begins.")
        add_dialogue("Karenna leaps like a panther around the padded mat of the training ring. Her movements are so fast, they are a blur. She attacks. At first she lands her blows at will, causing stings of pain that send ", local4, " reeling, but as the session progresses, ", local5, " ", local7, " ", local6, " reflexes have been sharpened noticeably.")

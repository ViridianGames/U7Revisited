...
function npc_grod_0154(eventid, objectref)
    ...
    var_0003 = npc_id_in_party(-220)
    var_0004 = get_lord_or_lady()
    var_0005 = get_player_name()
    set_alignment(get_npc_name(154), 2)
    ...
    while true do
        if cmps("name") then
            ...
            if var_0006 then
                ...
                var_0005 = get_player_name()
                var_0009 = "the Avatar"
                var_000A = utility_unknown_1035({var_0004, var_0005, var_0009})

...
function func_0862(eventid, itemref)
    ...
    if local1 then
        ...
        if local5 == "too much" then
            say(itemref, "\"Ah, I do know what thou dost mean! Thou dost need help, yes?\"")
            local2 = true
            call_0009H()
        else
            call_0861H()
    ...
    if local3 then
        ...
        if local5 == "That would be big of thee" or local5 == "I wish thou wouldst" then
            say(itemref, "\"What wilt thou give me for a clue?\"")
            local4 = true
            call_0009H()
        else
            call_0861H()
    ...
    if local4 then
        ...
        if local5 == "gold" then
            say(itemref, "\"Chuckles holds his hand up. \"'Tis not right. I give thee a clue for free. 'Tis here in this scroll.\"")
            local6 = give_item(false, -359, 1, 797, 1)
            if local6 then
                set_flag(111, true)
                call_0911H(50)
                call_0009H()
                say(itemref, "\"So long, my friend! Do not forg... I mean, do not lose how to play The Game!\"*")
                return
            else
                say(itemref, "\"Oh! Thou dost not have room for the scroll! Put down thy things and I shall give it to thee!\"*")
                return
            end
        elseif local5 == "a smile" then
            say(itemref, "\"How nice! All right! I shall give thee a clue. 'Tis here in this scroll.\"")
            local6 = give_item(false, -359, 1, 797, 1)
            if local6 then
                set_flag(111, true)
                call_0911H(50)
                ...
                say(itemref, "\"Oh! Thou dost not have room for the scroll! Put down some of thy things and I can give it to thee!\"*")
                return
            end

...
function npc_nicodemus_0102(eventid, objectref)
    ...
    var_0002 = count_objects(0, 359, 839, 357) --- Guess: Counts items
    ...
    while true do
        ...
        elseif var_0003 == "spells" then
            ...
            if var_0004 then
                utility_shop_0963() --- Guess: Purchases spells
            else
        ...
        elseif var_0003 == "reagents" then
            ...
            if var_0005 then
                utility_shopreagents_0964() --- Guess: Purchases reagents
            else
                add_dialogue("\"Never mind, then!\"")
            end
        elseif var_0003 == "potions" then
            ...
            if var_0006 then
                if get_party_gold() >= 75 then
                    var_0007 = add_party_items(true, 7, 359, 340, 1) --- Guess: Checks inventory space
                    if var_0007 then
                        add_dialogue("\"Here is the potion.\"")
                        var_0008 = remove_party_items(true, 359, 359, 644, 75) --- Guess: Deducts item and adds item
                    else

...
function utility_unknown_0415(eventid, objectref)
    ...
    for var_0001 in ipairs(var_0000) do
        ...
        if var_0005 == 6 then
            if var_0004 == 0 then
                ...
                utility_position_0894(var_0003, var_0006, var_0007, var_0008)
                var_0009 = create_new_object(739)
                get_object_frame(var_0009, 4)
                var_000A = update_last_created(var_0006)
            elseif var_0004 == 1 then
                var_0007 = 1
                var_0008 = {{2188, 1}, {1527, 2}, {0, 3}}
                utility_position_0894(var_0003, var_0006, var_0007, var_0008)
                var_000B = create_new_object(431)
                get_object_frame(var_000B, 3)
                var_000A = update_last_created(var_0006)
                sprite_effect(-1, 0, 0, 0, var_0006[2] - 1, var_0006[1] - 4, 13)
            elseif var_0004 == 2 then
                var_0007 = 2
                var_0008 = {{2187, 1}, {1521, 2}, {0, 3}}
                utility_position_0894(var_0003, var_0006, var_0007, var_0008)
                var_000C = create_new_object(991)
            ...
            elseif var_0004 == 4 then
                ...
                utility_position_0894(var_0003, var_0006, var_0007, var_0008)
                var_000D = create_new_object(741)
                get_object_frame(var_000D, 4)
                var_000A = update_last_created(var_0006)
                sprite_effect(-1, 0, 0, 0, var_0006[2] - 1, var_0006[1] - 5, 13)
            elseif var_0004 == 5 then
                var_0007 = 3
                var_0008 = {{2196, 1}, {1526, 2}, {0, 3}}
                utility_position_0894(var_0003, var_0006, var_0007, var_0008)
                var_000E = create_new_object(470)
            ...
            elseif var_0004 == 6 then
                ...
                utility_position_0894(var_0003, var_0006, var_0007, var_0008)
                var_000F = create_new_object(740)
                get_object_frame(var_000F, 12)
                var_000A = update_last_created(var_0006)
            end
        end
    end
    var_0010 = execute_usecode_array(objectref, {1696, 8021, 5, 17447, 8033, 4, 17447, 8048, 5, 7719})

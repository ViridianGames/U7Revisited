...
function func_08BD(local0, local1)
    ...
    elseif local6 == 1 then
        ...
        add_dialogue("You gather your gold and count it. You have ", local7, " altogether.")
    ...
    elseif local6 == 2 then
        ...
        add_dialogue("\"Very well,\" Markus says, stifling a yawn. \"Here we go.\"~~Markus wields his sword and faces ", local4, ". He gives ", local4, " a few pointers in stance and balance, then demonstrates some sample thrusts.")
        add_dialogue("Before long, ", local4, " and the trainer are trading blows with weapons. He is obviously very good at what he does, and the experience is valuable to ", local4, ". When the session is over, it is felt that there has been a gain in combat ability.")

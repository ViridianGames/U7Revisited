...
function utility_shop_0860()
    ...
    while var_0000 do
        ...
        if var_0009 == 1 then
            ...
            var_000A = utility_shop_1051(var_0004[var_0009], var_0001[var_0009], var_0005[var_0009], var_0009, var_0006[var_0009])
            var_000B = 0
            add_dialogue("\"^" .. var_000A .. " Art thou willing to pay my price?\"")
            var_000C = ask_yes_no()
            if not var_000C then
                var_000B = utility_shop_1016(false, var_0008, var_0003[var_0009], 0, var_0007[var_0009], var_0002[var_0009])
                if var_000B == 1 then

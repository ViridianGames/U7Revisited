    ...
    if eventid == 1 then
        ...
        while true do
                    ...
                    if local7 then
                        ...
                        if local8 then
                            ...
                            if local4 then
                                ...
                                switch_talk_to(2, 0)
                                add_dialogue("\"Mmmmm! I say, " .. local1 .. ", I think we need a lot of this for the road. We had best buy some, all right?\"*")
                                hide_npc(2)
                                switch_talk_to(52, 0)
                            end
                        else
            ...
            elseif answer == "bye" then
                add_dialogue("\"Good day to thee, " .. local0 .. ", and bon appetit!\"*")
                break
            end
        end

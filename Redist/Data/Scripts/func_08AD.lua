...
function func_08AD()
    ...
    if not get_flag(0x01AD) then
        ...
        add_dialogue("\"I thank thee, ", local0, ". That dark spirit had suppressed my will for so long that I was not sure I had one left. Thou hast done a great deed for Skara Brae, for myself and, indeed, all of Britannia, but then I suppose this is merely a matter of course for one such as thee. My gratitude is thine.\" He bows deeply to you.")
        ...
        add_dialogue("\"It is good to see thee again, ", local1, ".", local2, "\"")
    end
    ...
    if not get_flag(0x01AC) and not get_flag(0x01D1) then
        add_dialogue("\"Now, ", local0, ". I must ask this favor of thee. The Well of Souls, at the bottom of this tower, holds many tormented souls within it and binds the spirits of Skara Brae to this island. It must be destroyed.\" Horance looks at you intently.~ \"I can only hope that thou wilt try to free them.\"")
    ...
    elseif not get_flag(0x01A6) then
        add_dialogue("\"But please, ", local0, ", I beg thee make haste. Take Rowena to Trent! Time is short! Talk to her and take her to her husband! The souls in the well are constantly in pain, and some become so drained that they are snuffed out of existence like the flame of a candle.\" He looks as if he feels the pain himself.")

...
function func_08D0(local0, local1)
    ...
    elseif local8 == 2 then
        ...
        add_dialogue("Rayburt first instructs ", local3, " to lie on the floor and relax. He teaches ", local6, " breathing exercises and techniques with which to cleanse the mind of all thoughts.")
        add_dialogue("After a while, he asks ", local6, " to stand up and illustrates balance and control, relating it to meditation and concentration.")
        add_dialogue("Finally, he demonstrates several good moves involving hand-to-hand combat, and combat using a sword. By the end of the hour, ", local3, " ", local4, " much more knowledgeable and proficient in this unusual form of fighting.")

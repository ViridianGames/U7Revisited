--- Best guess: Manages a shop dialogue for purchasing jewelry and gems, handling item selection, pricing, and inventory checks.
function utility_shop_0995()
    start_conversation()
    ...
    save_answers()
    var_0000 = true
    var_0001 = {"ankh", "wedding ring", "gold ring", "gem", "nothing"}
    var_0002 = {955, 640, 640, 760, 0}
    var_0003 = {0, 1, 0, 359, 359}
    var_0004 = {200, 150, 100, 75, 0}
    var_0005 = "a "
    var_0006 = 0
    var_0007 = ""
    var_0008 = 1
    ...
    while var_0000 do
        ...
        if var_0009 == 1 then
            ...
            var_0011 = 0
            add_dialogue("^" .. var_0010 .. " Art thou willing to pay my price?")
            var_0012 = ask_yes_no()

        ...
        for i = 1, 5 do
            ...
            if get_object_quality(var_0006) == var_0002 then
                ...
                elseif var_0007 == 876 then
                    calle_0832H(935, var_0006) --- External call to add items
                elseif var_0007 == 936 then
                    calle_0833H(303, var_0006) --- External call to add items
                elseif var_0007 == 935 then
                    calle_0833H(876, var_0006) --- External call to add items
                end
            end
        end
    end

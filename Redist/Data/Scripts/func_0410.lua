...
function func_0410(eventid, itemref)
    ...
    if eventid == 1 then
        ...
        if not get_flag(79) then
            add_dialogue("\"Ah, Avatar! I recognized thee at once! Word has moved through town quickly. I had heard thou wert here.\"")
            set_flag(79, true)
        else
            add_dialogue("\"Hello again, " .. local0 .. ",\" Klog asks. \"How may I help thee?\"")
        end
        ...
        while true do
            ...
            elseif answer == "bye" then
                add_dialogue("\"If there is anything else I may help thee with, " .. local0 .. ", let me know.\"*")
                break
            end
        end

...
function func_0485(eventid, itemref)
    ...
    if eventid == 1 then
        ...
        if not get_flag(398) then
            ...
            add_dialogue("\"" .. local0 .. "!\" says a wide-eyed Constance, \"What may I do for thee?\"")
        end

        while true do
            local answer = get_answer()
            if answer == "name" then
                add_dialogue("\"My name, " .. local0 .. ", is Constance.\" She shyly lowers her eyes.")
                remove_answer("name")
            ...
            elseif answer == "bye" then
                add_dialogue("\"It was a pleasure speaking with thee, " .. local0 .. ".\"*")
                break
            end
        end

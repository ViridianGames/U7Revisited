...
function npc_james_0046(eventid, objectref)
    ...
    while true do
        ...
        elseif answer == "good husband" then
        ...
        elseif answer == "room" then
                ...
                if ask_yes_no() then
                    ...
                    if var_0009 >= var_0008 then
                        ...
                        if not var_000A then
                            ...
                            var_000B = remove_party_items(359, 359, 644, var_0008)
                        end
                    else
            ...
            remove_answer("room")
        elseif answer == "Cynthia said" then

...
function npc_ophelia_0122(eventid, objectref)
    ...
    var_0005 = is_dead(get_npc_name(125))
    var_0006 = is_dead(get_npc_name(126))
    var_0007 = is_dead(get_npc_name(127))
    var_0008 = is_dead(get_npc_name(124))
    ...
    while true do
                ...
                if var_0012 then
                    ...
                    if var_0012 == 0 then
                        ...
                        if var_000F >= var_0012 then
                            ...
                            var_0014 = add_party_items(false, 0, 359, 921, var_0012 // 10)
                            if var_0014 then
                                var_0015 = remove_party_items(true, 359, 359, 644, var_0012)
                                set_flag(357, true)
        ...
        elseif cmps("winnings") then
            if not get_flag(367) then
                ...
                var_0018 = add_party_items(true, 359, 359, 644, var_0017)
                if var_0018 then
                    var_0019 = remove_party_items(false, 0, 359, 921, var_0016)

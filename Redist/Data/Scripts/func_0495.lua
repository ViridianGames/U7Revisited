...
function func_0495(eventid, itemref)
    ...
    if not get_flag(711) then
        add_dialogue("You see a three-headed hydra. The head on the left speaks.~~ \"Wake up, there is something here.\"")
        switch_talk_to(282, 0)
        add_dialogue("The head on the right looks up and at you.~~\"I wonder if it is good to eat.\"*")
        hide_npc(282)
    ...
    while true do
        ...
        elseif answer == "Shandu" then
            add_dialogue("\"That is me.\"~~Shandu smiles and licks his lips.~~ \"I like it when my food says my name!\"")
        ...
        elseif answer == "Shando" then
            ...
            switch_talk_to(280, 0)
            add_dialogue("Shandu spits.~~\"What does it matter? Our food does not care which of us is the eldest!\"*")
            hide_npc(282)
            switch_talk_to(280, 0)
        ...
        elseif answer == "Caddellite" then
            if local0 == 0 then
                ...
                add_dialogue("\"Thou dost want to know about Caddellite? Very well, I shall tell thee about Caddellite.\"~~The hydra shifts its weight a moment, then grins wickedly.~~\"We are guarding it.\"")
                remove_answer("Caddellite")
                add_answer("guarding")
            end
        ...
        elseif answer == "steal" then
            add_dialogue("Shandu becomes enraged.~~\"I knew it! It is trying to steal our Caddellite!\"~~Shandu addresses his brothers.~~\"We must not delay any longer.\"*")
            switch_talk_to(281, 0)
            add_dialogue("Shanda roars angrily!*")
            hide_npc(281)
            switch_talk_to(280, 0)
            add_dialogue("\"That is a good idea, my brother!\"~~Shandu turns to you.~~ \"This creature vaguely resembles a troll, only it smells a little more pleasant. Dost thou think it might taste better than a troll, Shando?\"*")
            switch_talk_to(282, 0)

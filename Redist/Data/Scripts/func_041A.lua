    ...
    if not get_flag(56) then
        ...
        if ask_yes_no() then
            ...
            if not get_flag(56) then
                ...
                var_0002 = unknown_002CH(false, 1, 359, 955, 1)
                set_flag(145, true)
                set_flag(6, true)
                unknown_0911H(500)
                if var_0002 then
    ...
    while true do
        ...
        elseif cmps("package") then
            if get_flag(215) and not get_flag(143) then
                ...
                var_0008 = unknown_0029H(359, 359, 798, 26)
                var_0009 = unknown_0025H(var_0008)
                var_000A = unknown_0036H(356)
                if var_000A then
                    add_dialogue("\"Excellent! Here it is. Thou must now be on thy way!\"")
                    set_flag(143, true)
                    return
                else
                    var_000A = unknown_0036H(26)

...
function npc_rutherford_0092(eventid, objectref)
            ...
            if var_0002 == 23 then
                ...
                if ask_yes_no() then
                    ...
                    if var_000A >= var_0009 then
                        var_000B = add_party_items(true, 359, 255, 641, 1)
                        if not var_000B then
                            ...
                            var_000C = remove_party_items(359, 359, 644, var_0009)
                        end
                    else

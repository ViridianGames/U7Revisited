...
function func_0498(eventid, itemref)
    ...
    while true do
        ...
        elseif answer == "Penumbra" then
            ...
            add_dialogue("She shakes her head, muttering, \"Why doth " .. local6 .. " waste my time in this manner?\" Looking back up at you, she says, \"Penumbra is the sage who put herself to sleep two centuries ago. Rumor has it that only the Avatar can awaken her.\"")

...
function object_unknown_0504(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        elseif not find_nearest(30, 707, var_0000) then
            start_conversation()
    ...
    elseif eventid == 2 then
        ...
        if get_flag(822) ~= true then
            ...
            if not ask_yes_no() then
                ...
                var_000B = create_new_object(760)
                set_object_frame(var_000B, 12)
                var_000C = give_last_created(get_npc_name(356))
                if var_000C then
                    ...
                    if not var_000E then
                        var_000A = update_last_created(get_object_position(var_000E))
                    end
                end
            else

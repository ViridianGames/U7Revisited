...
function func_067A(eventid, objectref)
    ...
    if not unknown_0906H() then
        ...
        if not var_0004 then
            ...
            if var_0005 then
                ...
                var_0005 = unknown_0041H(621, var_0004, objectref)
        ...
        var_0005 = unknown_0001H(objectref, {17530, 17519, 17520, 8042, 65, 8536, var_0002, 7769})
    ...
    if var_0000 then
        var_0005 = unknown_0001H(objectref, {1542, 17493, 17519, 17520, 8554, var_0002, 7769})
    end
end
    ...
    if eventid == 1 then
        ...
        while true do
            ...
            if answer == "name" then
                ...
                add_dialogue("\"My name is Apollonia,\" she says, " .. local5)
                remove_answer("name")
            ...
            elseif answer == "room" then
                ...
                if get_answer() then
                    ...
                    if get_gold() >= local11 then
                        ...
                        add_dialogue("\"Thou dost not have enough gold, " .. local2 .. ".\"")
                    end
                else
            ...
            elseif answer == "flirt" then
                add_dialogue("Apollonia blushes and bats her eyelashes. \"Oh, " .. local1 .. "! I would wager that thou dost say that to all the barmaids!\"")
                remove_answer("flirt")

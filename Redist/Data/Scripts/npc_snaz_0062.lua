...
function npc_snaz_0062(eventid, objectref)
    ...
    while true do
        ...
        elseif answer == "beggar" then
            add_verses("\"When I was just a little boy I was made an orphan and left homeless and penniless. That was a joke life played on me. 'Tis a funny joke, eh?~~\"But I would not charge thee a gold piece for that one.\"")
            remove_answer("beggar")
        elseif answer == "tell a joke" then
        ...
        elseif answer == "Fellowship joke" then
            add_verses("\"I was discussing philosophy with a Fellowship member the other day and he asked me, 'What, in thine opinion, is the height of stupidity?'~~\"So I said, 'I do not know. How tall art thou?'~~\"No, really, I make sport of The Fellowship, but I mean it sincerely...\"")
            remove_answer("Fellowship joke")
            add_answer({"Lord British joke", "Fellowship"})
        elseif answer == "Fellowship" then
            add_verses("\"That is what I dearly love about The Fellowship. They could always take a joke!~~\"And from what I hear they play funny jokes themselves! Like the joke they played in Trinsic!\"")
            remove_answer("Fellowship")
        elseif answer == "Lord British joke" then
            ...
            if not var_0003 then
                ...
                if var_0004 then
                    add_verses("\"I was at the castle of Lord British the other day and I noticed he has three large pools. So I asked why he doth have three of them.~~\"He pointed to the first one and said the first was to swim in cool water.~~\"The second was for friends to swim in warm water.~~\"I noticed that the third pool was empty and I asked him why.~~\"He said that it was for people who could not swim!\"")
                    remove_answer("Lord British joke")
        ...
        elseif answer == "Lord British" then
            add_verses("\"Poor Lord British! When faced with a gigantic menace that threatens his entire kingdom he is an extremely capable ruler.~~\"But what happens when there are a myriad of smaller things that all threaten the welfare of his people indirectly?~~\"There is a riddle for thee to solve!\"")
            remove_answer("Lord British")
        elseif answer == "Weston joke" then
            add_dialogue("\"For a gold coin I will tell thee another. Dost thou wish to hear it?\"")
            var_0005 = ask_yes_no()
            if not var_0005 then
                ...
                if var_0006 then
                    add_verses("\"A man named Weston came to me deep in perplexity.~~\"He told me he wanted to steal some apples from the Royal Orchards but if he did he would feel bad about it in the morning.~~\"So I gave him this advice -- sleep until noon!\"")
                    remove_answer("Weston joke")
        ...
        elseif answer == "Weston" then
            add_verses("\"Weston now sits in the castle prison, where he shall most certainly rot for the rest of his life. Heh-heh-heh!~~\"Try as I might, I cannot best that little jest!\"")
            remove_answer("Weston")
        elseif answer == "mage joke" then
            add_dialogue("\"For a gold coin I will tell thee another. Dost thou wish to hear it?\"")
            var_0007 = ask_yes_no()
        ...
        elseif answer == "mages" then
            ...
            remove_answer("mages")
        elseif answer == "Sullivan joke" then
            ...
            if not var_0009 then
                ...
                if var_000A then
                    add_verses("\"Didst thou knowest that the notorious Sullivan the Trickster recently became a father?~~\"It is true! They say the baby has his father's eyes and his mother's nose, but they made the baby give them back.\"")
        ...
        elseif answer == "Sullivan" then
            add_verses("\"Yes, I know the man they call Sullivan the Trickster! In fact thou dost remind me of him!~~\"Or does he remind me of thee?~~\"He is so tricky that just talking about him has caused me to trick myself! Heh-Hee-Haa!\"")
            remove_answer("Sullivan")
        elseif answer == "gold joke" then

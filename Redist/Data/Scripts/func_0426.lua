...
function func_0426(eventid, itemref)
    ...
    if eventid == 1 then
        ...
        add_dialogue("\"Why, what can I do for thee, " .. local0 .. "?\" asks Greg.")
        ...
        while true do
            ...
            elseif answer == "dressed like Avatar" then
                add_dialogue("\"He was dressed like the Avatar, similarly to how thou art presently attired. At first I thought it was Jesse, the actor who is playing the Avatar in the play by that director... What is his name again?~~\"Oh, well. It was not him.\"")

...
function func_0426(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        while true do
            ...
            elseif var_0004 == "Lord British" then
                ...
                var_0004 = unknown_0931H(359, 359, 838, 1, 356) --- Guess: Verifies Avatar identity
                if var_0004 then
            ...
            elseif var_0004 == "buy" then
                if var_0002 ~= 7 then
                    ...
                    unknown_0899H() --- Guess: Processes provision purchase
                end
                remove_answer("buy")
    ...
    elseif eventid == 0 then
        ...
        if var_0002 == 7 then
            ...
            unknown_092EH(38) --- Guess: Triggers a game event
        end
    end
end
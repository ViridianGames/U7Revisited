...
function npc_figg_0045(eventid, objectref)
    ...
    while true do
        ...
        elseif cmps("Fellowship") then
            ...
            if var_0002 then
                ...
                var_0005 = add_party_items(true, 16, 359, 377, 1)
                if var_0005 then
        ...
        elseif cmps("buy") then
            ...
            var_0006 = ask_yes_no()
            if var_0006 then
                var_0007 = remove_party_items(359, 359, 644, 5)
                if var_0007 then
                    var_0008 = add_party_items(true, 16, 359, 377, 1)
                    if var_0008 then

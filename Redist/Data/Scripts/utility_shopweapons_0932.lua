...
function utility_shopweapons_0932()
    start_conversation()
    ...
    while var_0001 do
        ...
        if var_0010 == 1 then
            ...
            var_0011 = utility_shop_1051(var_0006, var_0002[var_0010], var_0007, var_0005[var_0010], var_0008)
            var_0012 = 0
            add_dialogue("^" .. var_0011 .. " Is that agreeable?")
            var_0013 = ask_yes_no()
            if not var_0013 then
                var_0012 = utility_shop_1016(false, 1, 0, var_0005[var_0010], var_0009, var_0004, var_0003[var_0010])
            end
            if var_0012 == 1 then

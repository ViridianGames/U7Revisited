...
function func_080F(eventid, objectref)
    local var_0000, var_0001, var_0002, var_0003, var_0004, var_0005, var_0006, var_0007, var_0008, var_0009, var_000A

    if eventid == 3 then
        var_0000 = unknown_0035H(0, 15, 867, objectref)
        var_0001 = unknown_0035H(0, 15, 338, objectref)
        var_0002 = unknown_0035H(0, 15, 336, objectref)
        var_0003 = unknown_0035H(176, 15, 810, objectref)
        var_0004 = unknown_0035H(128, 15, 912, objectref)
        var_0005 = unknown_0035H(0, 15, 636, objectref)
        var_0006 = unknown_0035H(176, 15, 168, objectref)

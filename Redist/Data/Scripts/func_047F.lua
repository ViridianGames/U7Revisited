...
function func_047F(eventid, itemref)
    ...
    if eventid == 1 then
        ...
        elseif get_flag(368) then
            if local1 == 4 then
                add_dialogue("\"Well, " .. local0 .. ", I must prove myself to De Snel. If thou art the one who suffers, I will apologize, but I will not back down!\"")
                ...
                add_dialogue("\"Well, " .. local0 .. ", I must prove myself to De Snel. If thou art the one who suffers, so be it! Meet us at the dueling area at next noon!\"*")
            end
        end
        ...
        while true do
            ...
            if answer == "name" then
                add_dialogue("\"Timmons is my name, " .. local0 .. ".\"")
                remove_answer("name")
            ...
            elseif answer == "bye" then
                add_dialogue("\"It was a pleasure speaking to thee, " .. local0 .. ".\"*")
                break
            end
        end

...
function func_0479(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        var_0002 = unknown_001CH(121) --- Guess: Gets object state
        ...
        while true do
            ...
            elseif var_0003 == "armour" then
                unknown_08AAH() --- Guess: Purchases armour
            elseif var_0003 == "weapons" then
                unknown_08A9H() --- Guess: Purchases weapons
            ...
            elseif var_0003 == "honor flag" then
                ...
                if var_0004 then
                    if not get_flag(368) then
                        ...
                        set_flag(359, true)
                        set_flag(379, true)
                        unknown_0066H(0) --- Guess: Starts flag crafting
                        abort()
                    else
            ...
            elseif var_0003 == "false flag" then
                var_0005 = unknown_0065H(0) --- Guess: Checks flag crafting status
                if var_0005 <= 2 then
                    ...
                    var_0006 = unknown_002CH(false, 359, 359, 286, 1) --- Guess: Checks inventory space
                    if var_0006 then
    ...
    elseif eventid == 0 then
        var_0001 = unknown_003BH() --- Guess: Checks game state
        var_0002 = unknown_001CH(121) --- Guess: Gets object state
        var_0006 = unknown_0010H(4, 1) --- Guess: Generates random number
        if var_0002 == 7 or var_0002 == 19 then
            if var_0006 == 1 then
            ...
            unknown_0040H(var_0007, 121) --- Guess: Item says message
        else
            unknown_092EH(121) --- Guess: Triggers a game event
        end
    end
end
    ...
    if eventid == 1 then
        ...
        while true do
            ...
            elseif answer == "heal" then
                if is_party_member(local2, local1) then
                    if not get_flag(41) then
                        local8 = apply_effect(10) -- Unmapped intrinsic 0065
                        if local8 then
                    ...
                    apply_effect(400, 15, 30) -- Unmapped intrinsic 089E
                end
            ...
            elseif answer == "leave" then
                ...
                local10 = get_answer(answers)
                if local10 == "wait here" then
            ...
            elseif answer == "Dupre" then
                if local6 then
                    ...
                    local11 = get_item_type() -- Unmapped intrinsic 090A
                    if local11 then

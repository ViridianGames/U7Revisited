...
function func_0405(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        while true do
            ...
            elseif var_0003 == "heal" then
                if is_in_int_array(var_0001, get_party_members()) then
                    if get_flag(41) then
                        var_0004 = unknown_0065H(10) --- Guess: Checks party status or conditions
                    else
                        var_0004 = 5
                    end
                    if var_0004 < 4 then
                        ...
                        unknown_089EH(0, 0, 0) --- Guess: Heals party member
                    end
                else
                    unknown_089EH(400, 15, 30) --- Guess: Heals party member
                end
            ...
            elseif var_0003 == "join" then
                ...
                if var_0005 < 8 then
                    ...
                    unknown_001EH(5) --- Guess: Removes object from game
                    add_answer("leave")
                    remove_answer("join")
                else
    ...
    elseif eventid == 0 then
        unknown_092EH(5) --- Guess: Triggers a game event
    end
end
...
function npc_cynthia_0042(eventid, objectref)
            ...
            if var_0003 == 30 then
                ...
                if var_0004 then
                    ...
                    if not var_0007 then
                        ...
                        var_0008 = count_objects(359, 359, 645, 357)
                        var_0009 = count_objects(359, 359, 646, 357)
                        var_000A = 10 * var_0008
                        var_000B = 100 * var_0009
                        var_000C = var_000A + var_000B
                        var_000D = add_party_items(true, 359, 359, 644, var_000C)
                        if not var_000D then
                            ...
                            var_000E = remove_party_items(359, 359, 645, var_0008)
                            var_000F = remove_party_items(359, 359, 646, var_0009)

...
function func_0314(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        var_0001 = -1
        var_0002 = -3
        unknown_0828H(7, objectref, 788, var_0002, var_0001, var_0000, objectref)
    elseif eventid == 7 or eventid == 2 then
        ...
        var_0007 = unknown_0035H(0, 15, 870, objectref)
        var_0008 = unknown_0035H(0, 15, 515, objectref)

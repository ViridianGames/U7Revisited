...
function utility_unknown_0862()
    ...
    while var_0001 do
        ...
        if var_000A == 1 then
            ...
            var_000B = utility_shop_1051(var_0006, var_0002[var_000A], var_0007, var_000A, var_0008)
            var_000C = 0
            add_dialogue("\"^" .. var_000B .. " Dost thou accept my price?\"")
            var_000D = ask_yes_no()
            if not var_000D then
                var_000C = utility_shop_1016(true, var_0009, var_0005[var_000A], 0, var_0004[var_000A], var_0003[var_000A])
                if var_000C == 1 then
                    add_dialogue("\"Agreed.\"")

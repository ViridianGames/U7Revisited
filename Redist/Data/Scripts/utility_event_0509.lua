...
function utility_event_0509(eventid, objectref)
    ...
    if eventid == 2 then
        ...
        for i = 1, #var_0002 do
            var_0005 = var_0002[i]
            var_0006 = get_item_quality(var_0005)
            var_0007 = get_item_frame(var_0005)
        ...
        elseif not is_not_blocked(0, 721, {var_0009[1], var_0009[2] - 2, var_0009[3]}) then
            ...
            set_item_frame(6, var_0012)
            set_item_flag(18, var_0012)
            var_0011 = set_item_quality(151, var_0012)
            var_0011 = update_last_created(var_0009)

...
function func_0417(eventid, itemref)
    ...
    if eventid == 1 then
        ...
        if get_flag(30) then
            switch_talk_to(23, 0)
            add_dialogue("\"Fool!! What possessed thee to cast that damned Armageddon Spell? I knew it was dangerous! Thou didst know it was dangerous!! Now look at us! We are all alone on the entire planet! Britannia is ruined! What kind of Avatar art thou!?! Now, with no Moongates working, we are both forced to spend eternity in this blasted wasteland!")
            add_dialogue("\"Of course, it could be viewed as a clever solution to all of our problems. After all, not even this so-called Guardian would want Britannia now!\"*")
            return
        end
        if get_flag(780) and not get_flag(781) then
            local0 = true
            switch_talk_to(23, 0)
            add_dialogue("\"I felt the passing of the remains of Exodus from this realm. It has lifted a great weight from my shoulders. And so Avatar, I cannot let this accomplishment go unrewarded. Please kneel, my friend.\" Lord British holds out his hands as you obey his command.")
            goto exodus_event
        end
        ...
        if not get_flag(152) then
            ...
            add_dialogue("\"Yes, " .. local1 .. "?\" Lord British asks.")
        end
        ...
        while true do
            ...
            elseif answer == "Orb of the Moons" then
                ...
                if get_answer() then
                    add_dialogue("\"Really? Where is it? Thou dost not have it on thee! ")
                else
                    add_dialogue("\"I see. ")
                end
            ...
            elseif answer == "Weston" then
                ...
                add_dialogue("\"I do not recall this case. Let me check... Hmmm...\" He quickly scans a large scroll.")
            ...
            elseif answer == "island" then
                add_dialogue("\"Yes, " .. local1 .. ". I felt a great disturbance in the ether when this island arose from the sea. The island is none other than the Isle of Fire where thou defeated the Hellspawn Exodus.\"")
                remove_answer("island")
                add_answer({"Exodus", "Isle of Fire"})
            elseif answer == "Isle of Fire" then
                add_dialogue("\"" .. local1 .. ", thou shouldst know that when I created the shrines of the Virtues, I also set upon this island three great shrines, dedicated to the Principles of Truth, Love, and Courage.\"")
            ...
            elseif answer == "Exodus" then
                add_dialogue("\"Thy battle with that strange mixture of machine and spirit is now legendary. Do be careful if thou art going to the island, for the remains of that being now reside in one of the chambers of the Castle of Fire.\"")
                remove_answer("Exodus")
            elseif answer == "bye" then
                add_dialogue("\"Goodbye, " .. local1 .. ". Do come back soon.\"*")
                break
            end
        end

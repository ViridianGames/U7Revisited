    ...
    if eventid == 1 then
        ...
        while true do
            ...
            elseif var_0009 == "Orb of the Moons" then
                ...
                var_0009 = unknown_002CH(false, 359, 785, 1) --- Guess: Adds item to inventory
                if var_0009 then
            ...
            elseif var_0009 == "mad mage" then
                ...
                set_flag(101, true)
                unknown_0911H(20) --- Guess: Adds item or triggers quest
            ...
            elseif var_0009 == "heal" then
                unknown_08B4H(0, 0, 0) --- Guess: Heals player
                var_0006 = true
            elseif var_0009 == "Weston" then
                ...
                set_flag(204, true)
                unknown_0911H(20) --- Guess: Adds item or triggers quest
                unknown_003FH(69) --- Guess: Triggers quest event
            ...
            elseif var_0009 == "Isle of Fire" then
                ...
                unknown_08B5H() --- Guess: Activates access to shrines

        ...
        elseif cmps("way out") then
            ...
            if var_0001 then
                ...
                if var_0002 then
                    ...
                    var_0005 = unknown_002CH(false, 4, 359, 842, 8)
                    var_0006 = unknown_002CH(false, 5, 359, 842, 8)
                    var_0007 = unknown_002CH(false, 3, 359, 842, 6)
                    var_0008 = unknown_002CH(false, 2, 359, 842, 7)
                    var_0009 = unknown_002CH(false, 6, 359, 842, 6)
                    var_000A = unknown_002CH(false, 7, 359, 842, 8)

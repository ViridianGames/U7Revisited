...
function npc_petre_0011(eventid, objectref)
    ...
    while true do
        ...
        elseif answer == "carriage" then
            ...
            if var_0005 then
                var_0006 = count_objects(59, 359, 644, 357)
                if var_0006 >= 60 then
                    var_0007 = add_party_items(false, 359, 28, 797, 1)
                    if var_0007 then
                        add_dialogue("\"Very good. Nothing like a little business transaction to take my mind off the ghastly scene in the stables.\"")
                        var_0008 = remove_party_items(359, 359, 644, 60)
                    else

    ...
    if eventid == 1 then
        ...
        while true do
            ...
            elseif answer == "sextant" then
                var_0009 = false
                for i = 1, 5 do
                    var_000A = unknown_0035H(0, 40, 650, 356)
                    var_0008 = unknown_0012H(var_000A)
                    if var_0008 == 1 then
                        var_0009 = true
                        break
                    end
            ...
            elseif answer == "kite" then
                var_000D = unknown_000EH(1, 329, 356)
                if var_000D then
            ...
            elseif answer == "have crystal" then
                var_000F = unknown_0931H(359, 359, 746, 1, 357)
                if var_000F then

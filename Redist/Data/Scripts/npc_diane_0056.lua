...
function npc_diane_0056(eventid, objectref)
    ...
    if eventid == 1 then
        ...
        while true do
            ...
            elseif var_0003 == "carriage" then
                ...
                if var_0003 then
                    var_0004 = count_objects(359, 359, 644, 357) --- Guess: Checks player inventory or gold
                    if var_0004 >= 120 then
                        var_0005 = add_party_items(false, 359, 29, 797, 1) --- Guess: Checks inventory space
                        if var_0005 then
                            add_dialogue("\"Very good. Here is thy title.\"")
                            var_0006 = remove_party_items(true, 359, 359, 644, 120) --- Guess: Deducts gold and adds title
                        else

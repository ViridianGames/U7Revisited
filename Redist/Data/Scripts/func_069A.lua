...
function func_069A(eventid, itemref)
    ...
    var_0004 = unknown_0001H(itemref, {1691, 8021, 4, 17447, 8047, 1, 17447, 8048, 1, 17447, 8033, 1, 17447, 8045, 1, 17447, 8044, 1, 17447, 8044, 1, 8487, var_0003, 7769})
end
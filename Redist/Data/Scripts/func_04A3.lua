...
function func_04A3(eventid, itemref)
    ...
    if local3 == 7 then
        ...
        if local5 then
            add_dialogue("\"Sorry, ", local1, ", I may talk to thee later. But now I wish to pay attention to the meeting.\"")
        else
            add_dialogue("\"Sorry, ", local1, ", I must get to the Fellowship meeting!\"")
        end
        return -- abrt
    end
    ...
    if not get_flag(0x0205) then
        ...
        add_dialogue("\"How may I help thee, ", local1, "?\" asks Phearcy.")
    end
    ...
    if not get_flag(0x01DA) and not get_flag(0x01D9) then
        ...
        if local6 then
            ...
            if not local7 then
                add_dialogue("\"Too bad, ", local1, ". When thou art carrying less weighty things I shall give thee thy jerky.\"")
            end
            ...
            add_dialogue("\"'Tis a shame, ", local1, ". Perhaps thou wilt know next time.\"")
        end
    end

        ...
        if local9 == 1 then
            ...
            if local12 then
                if local2[local9] == 595 or local2[local9] == 782 then
                    say(itemref, local2[local9] == 782 and "\"To want how many sets of twelve?\"" or "\"To want how many?\"")
            ...
            if local11 == 1 then
                say(itemref, "\"To accept!\"")
            elseif local11 == 2 then
                say(itemref, "\"To be unable to travel with that much weight!\"")
            elseif local11 == 3 then
                say(itemref, "\"To have not the money for that!\"")
            end
            say(itemref, "\"To make another purchase?\"")
            local0 = get_answer()
        end
    end
    _RestoreAnswers()

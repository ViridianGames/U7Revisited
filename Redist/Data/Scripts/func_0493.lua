    ...
    if eventid == 1 then
        ...
        if not get_flag(460) then
            if not get_flag(426) then
                ...
                add_dialogue("\"Ah, hello, " .. local5 .. ". May I be off assistance to thee?\"")
            end
            set_flag(460, true)
        else
            if not get_flag(418) then
                add_dialogue("\"Greetings, " .. local5 .. ".\" The mayor smiles at you half-heartedly.")
            else
                ...
                add_dialogue("\"Ah yes, good Avatar. 'Tis good to see thee again. " .. local8 .. "Of what service can I be to one so great as thee?\" He bows.")
            end
        ...
        while true do
            ...
            elseif answer == "fire" then
                ...
                remove_answer("fire")
                if not get_flag(426) then
                    add_dialogue("\"Of course, now thou hast already taken care of all that!\" He smiles graciously.")
                else
            ...
            elseif answer == "Horance" then
                add_dialogue("\"Well, if I've got all this Liche lore straight, then, Horance, who used to be a good and kindly mage, has become a nasty, horrible, undead mage.\" He smiles patronizingly. \"Now run along. Thou canst add_answer(\"Mistress Mordra\") if thou needest more information.\"")
            ...
            elseif answer == "sacrifice" then
                if not get_flag(415) then
                    ...
                    if not get_flag(418) then
                        add_dialogue("The Mayor's eyes dart back and forth as you ask him to sacrifice himself for the good of his people. \"There is still one thou hast neglected to ask. Go and find " .. local6 .. ". Then come back and we'll see.\" Spectral sweat drips from his ghostly forehead.")
                        add_answer(local7)
                    else
                        apply_effect() -- Unmapped intrinsic
                    end

    ...
    if eventid == 1 then
        ...
        if is_in_int_array(var_0004, var_0003) then
            ...
            if var_0005 then
                ...
                unknown_088BH() --- Guess: Frees souls from well
            else
        ...
        while true do
            ...
            elseif var_0009 == "sacrifice" then
                if not get_flag(415) then
                    if not get_flag(418) then
                        ...
                        unknown_088AH() --- Guess: Progresses quest
                    end
                else
                    if not get_flag(418) then
            ...
            elseif var_0009 == "leave" then
                ...
                unknown_001FH(147) --- Guess: Sets object state
                unknown_001DH(11, 147) --- Guess: Sets object behavior

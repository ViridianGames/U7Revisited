...
void WorldEditorState::Draw()
{
	...
	DrawTextEx(*g_SmallFont, "Welcome to the World Editor!  It doesn't work yet. Sorry.", Vector2{ 0, 0 }, g_SmallFont->baseSize, 0, WHITE);
	DrawTextEx(*g_SmallFont, "Press ESC to exit.", Vector2{ 0, g_smallFontSize }, g_SmallFont->baseSize, 0, WHITE);
